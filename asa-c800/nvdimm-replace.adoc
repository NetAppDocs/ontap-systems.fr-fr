...
summary: 'Vous devez remplacer la barrette NVDIMM du module contrôleur lorsque votre système détecte que la durée de vie du flash est presque terminée ou que la barrette NVDIMM identifiée n"est pas saine. Si vous ne le faites pas, cela provoquera une panique du système.' 
---
= Remplacez un module NVDIMM - ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la NVDIMM de votre système ASA C800 lorsque celui-ci détecte que la durée de vie de la mémoire flash est presque terminée ou que la NVDIMM identifiée est globalement défectueuse ; le non-respect de cette consigne provoque un plantage du système.

.Avant de commencer
* Assurez-vous que le module NVDIMM de remplacement que vous avez reçu de NetApp est compatible avec votre système ASA C800 .
