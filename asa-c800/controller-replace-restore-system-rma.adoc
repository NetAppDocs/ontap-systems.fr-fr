...
summary: Pour rétablir le fonctionnement complet de votre système ASA C800, restaurez la configuration de chiffrement du stockage NetApp si nécessaire, installez les licences pour le nouveau contrôleur et renvoyez la pièce défectueuse à NetApp. 
---
