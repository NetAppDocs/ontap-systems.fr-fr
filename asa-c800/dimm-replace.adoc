...
summary: 'Remplacez une barrette DIMM dans votre système ASA C800 si un nombre excessif d"erreurs de mémoire, corrigibles ou non, est détecté. De telles erreurs peuvent empêcher le système de stockage de démarrer ONTAP.' 
---
