...
summary: 'Remplacez la pile de l"horloge temps réel, communément appelée pile bouton, dans votre système ASA C800 pour garantir que les services et applications nécessitant une synchronisation horaire précise restent opérationnels.' 
---
...
[role="lead"]
Remplacez la pile de l'horloge temps réel (RTC), communément appelée pile bouton, de votre système ASA C800 pour garantir le fonctionnement des services et applications nécessitant une synchronisation horaire précise.
