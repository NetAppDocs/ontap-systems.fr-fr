...
---
= Remplacez la batterie NVDIMM - ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la batterie NV de votre système ASA C800 lorsque celle-ci commence à se décharger ou tombe en panne, car elle est responsable de la préservation des données critiques du système pendant les coupures de courant. Le processus de remplacement implique l'arrêt du contrôleur défectueux, le retrait du module de contrôleur, le remplacement de la batterie NV, la réinstallation du module de contrôleur et le renvoi de la pièce défectueuse à NetApp.



== Étape 1 : Arrêter le contrôleur défectueux
...
Remplacez la pile NVDIMM en retirant la pile défectueuse du module de contrôleur et en installant la pile de remplacement dans le module de contrôleur.
