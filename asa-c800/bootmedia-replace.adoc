...
---
= Remplacez le support de démarrage - ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_a800_boot_media_replace.png[remplacement du support de démarrage drw a800]
...
.. Copiez le dossier efi dans le répertoire supérieur du lecteur flash USB. + le lecteur flash USB doit avoir le dossier efi et la même version de l'image de service (BIOS) de ce que le contrôleur douteux est en cours d'exécution.
