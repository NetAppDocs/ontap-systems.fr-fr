...
summary: 'Remplacez le bloc d"alimentation de votre AFF A250 en déconnectant le bloc d"alimentation cible de la source d"alimentation, en débranchant le câble d"alimentation, en retirant l"ancien bloc d"alimentation, en installant le bloc d"alimentation de remplacement, puis en le reconnectant à la source d"alimentation.' 
---
= Remplacement à chaud d'une alimentation - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
