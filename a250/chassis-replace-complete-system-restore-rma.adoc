...
---
= Terminez le remplacement du châssis - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Redémarrez les contrôleurs, vérifiez l'état du système et renvoyez la pièce défectueuse à NetApp pour compléter la dernière étape de la procédure de remplacement du châssis AFF A250.
