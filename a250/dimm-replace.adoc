...
summary: 'Remplacez une barrette DIMM dans votre AFF A250 controller lorsque le système rencontre un nombre excessif d"erreurs CECC basées sur les alertes du Health Monitor, ou des erreurs ECC non corrigibles qui empêchent le système de stockage de démarrer ONTAP.' 
---
