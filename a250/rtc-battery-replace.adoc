...
summary: 'Remplacez la pile de l"horloge temps réel dans votre module contrôleur AFF A250 pour garantir le bon fonctionnement des services et applications qui dépendent d"une synchronisation horaire précise.' 
---
