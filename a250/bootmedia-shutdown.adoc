...
---
= Arrêter le contrôleur pour la récupération manuelle du support de démarrage - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Éteignez le contrôleur défectueux de votre AFF A250 pour éviter la perte de données et maintenir la stabilité du système pendant le processus automatisé de récupération du support de démarrage.
