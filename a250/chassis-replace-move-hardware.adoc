...
[role="lead"]
Remplacez le châssis de votre système AFF A250 lorsqu'une défaillance matérielle l'exige. La procédure de remplacement consiste à retirer les contrôleurs et les blocs d'alimentation (PSU), à retirer les disques, à installer le châssis de remplacement et à réinstaller les composants du châssis.
...
.Et la suite ?
Après avoir remplacé le châssis défectueux de l'AFF A250 et réinstallé les composants, vous devez link:chassis-replace-complete-system-restore-rma.html["terminez le remplacement du châssis"]
