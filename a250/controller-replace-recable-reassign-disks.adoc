...
---
= Recable du système et reassigner des disques - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir terminé la restauration et vérifié la configuration du système AFF A250, vous devez recâbler le système et réaffecter les disques.
