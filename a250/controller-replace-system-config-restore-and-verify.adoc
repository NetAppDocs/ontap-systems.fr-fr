...
[role="lead"]
Après avoir effectué le remplacement du matériel et démarré votre système A250 en mode Maintenance, vous devez vérifier la configuration système de bas niveau du contrôleur de remplacement et reconfigurer les paramètres système si nécessaire.
