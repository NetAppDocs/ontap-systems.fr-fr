...
---
= Remplacez le matériel du module de contrôleur - AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_a800_replace_fan.png[drw a800 remplacer le ventilateur]
...
+
image::../media/drw_a800_no_risers_nvdimm_move.png[drw a800 pas de surmontoirs déplacer nvdim]
...
Le système AFF A800 contient un périphérique de démarrage. Vous devez le déplacer du contrôleur défaillant et l'installer dans le contrôleur _replacement_.

Le support de démarrage est situé sous le surmontoir 3.

. Recherchez le support de démarrage :
+
image::../media/drw_a800_pcm_replace_only_boot_media.png[le module de commande du processeur drw a800 remplace uniquement le support de démarrage]
