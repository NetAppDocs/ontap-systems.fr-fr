...
summary: 'Remplacez la pile de l"horloge temps réel de votre module contrôleur AFF A800 pour garantir le bon fonctionnement des services et applications qui dépendent d"une synchronisation horaire précise.' 
---
= Remplacer la batterie de l'horloge en temps réel - AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la pile de l'horloge temps réel (RTC), communément appelée pile bouton, de votre système AFF A800 pour garantir le bon fonctionnement des services et applications nécessitant une synchronisation horaire précise.
