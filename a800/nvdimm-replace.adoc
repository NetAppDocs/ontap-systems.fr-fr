...
summary: 'Remplacez la NVDIMM dans le module contrôleur AFF A800 lorsque le système indique que la durée de vie de la mémoire flash est presque terminée ou que la NVDIMM identifiée n"est pas saine. Le fait de ne pas remplacer une NVDIMM défectueuse peut provoquer une panique du système.' 
---
...
[role="lead"]
Remplacez la NVDIMM de votre système AFF A800 lorsque celui-ci détecte que la durée de vie de la mémoire flash est presque terminée ou que la NVDIMM identifiée est globalement défectueuse ; le non-respect de cette consigne provoque un plantage du système.

.Avant de commencer
* Assurez-vous que la barrette NVDIMM de remplacement que vous avez reçue de NetApp est compatible avec votre système AFF A800 .
