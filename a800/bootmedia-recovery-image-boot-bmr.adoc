...
---
= Récupération automatique du support de démarrage à partir du nœud partenaire - AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
