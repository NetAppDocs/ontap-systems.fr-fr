...
summary: Pour remplacer le contrôleur de votre système de stockage AFF A800, commencez par éteindre le contrôleur défectueux, retirez et remplacez le contrôleur, reconfigurez les paramètres du système et vérifiez le fonctionnement du système. 
---
= Processus de remplacement du contrôleur - AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le contrôleur de votre système de stockage AFF A800 en arrêtant le contrôleur défectueux, en le retirant et en le remplaçant, en restaurant la configuration du système et en redonnant le contrôle des ressources de stockage au contrôleur de remplacement.
