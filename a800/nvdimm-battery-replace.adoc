...
[role="lead"]
Remplacez la pile NV de votre système AFF A800 lorsque celle-ci commence à se décharger ou tombe en panne, car elle est responsable de la préservation des données critiques du système pendant les coupures de courant. Le processus de remplacement implique l'arrêt du contrôleur défectueux, le retrait du module de contrôleur, le remplacement de la batterie NV, la réinstallation du module de contrôleur et le renvoi de la pièce défectueuse à NetApp.
