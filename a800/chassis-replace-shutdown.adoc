...
[role="lead"]
Éteignez les contrôleurs de votre système de stockage AFF A800 pour éviter toute perte de données et garantir la stabilité du système lors du remplacement du châssis.
