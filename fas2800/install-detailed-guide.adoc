...
NOTE: Si votre système ne possède pas d'étagères externes, consultez link:../sas3/install-cabling-worksheets-examples-fas2600.html#fas2820-platform-in-a-multipath-ha-configuration-with-no-external-shelves["Instructions de câblage pour FAS2820 en configuration HA multipath sans étagères externes"].
