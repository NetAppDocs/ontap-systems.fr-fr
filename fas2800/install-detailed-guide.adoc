...
Aucune étiquette de référence
 a| 
image::../media/oie_cable_power.png[alimentation du câble de l'oie]
 a| 
...
Le câblage tiroir à tiroir
 ...
 a| 
image::../media/icon_square_2_yellow.png[icône carré 2 jaune]
 a| 
Contrôleur A vers les tiroirs disques
 ...
 a| 
image::../media/icon_square_3_orange.png[icône carré 3 orange]
 a| 
