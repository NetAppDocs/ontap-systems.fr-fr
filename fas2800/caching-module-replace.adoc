...
summary: Vous devez remplacer le module de cache du contrôleur lorsque votre système enregistre un seul message ASUP AutoSupport indiquant que le module est hors ligne. Si vous ne remplacez pas le module défaillant, les performances de votre système de stockage seront dégradées. 
---
