...
summary: Vous devez remplacer une barrette DIMM dans le contrôleur lorsque votre système de stockage rencontre des erreurs telles que des erreurs ECC corrigibles excessives basées sur les alertes du Health Monitor, ou des erreurs ECC non corrigibles qui empêchent le système de stockage de démarrer ONTAP. 
---
