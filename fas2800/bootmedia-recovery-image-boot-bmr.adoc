...
summary: 'Restaurez l’image ONTAP sur le support de démarrage de remplacement de votre système fas2800.  Le processus implique le lancement du processus de récupération de démarrage à partir de l"invite LOADER et la surveillance du processus de récupération jusqu"à ce qu"il soit terminé et que le nœud redémarre.' 
---
= Récupération automatique du support de démarrage à partir du nœud partenaire - FAS2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
