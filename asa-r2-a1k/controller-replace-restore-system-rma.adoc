...
summary: 'Pour terminer le remplacement du contrôleur de votre système ASA A1K, commencez par restaurer la configuration du chiffrement du stockage NetApp si nécessaire. Ensuite, vérifiez que les interfaces logiques sont rattachées à leurs ports d"attache et effectuez une vérification de l"état du cluster. Enfin, retournez la pièce défaillante à NetApp.' 
---
