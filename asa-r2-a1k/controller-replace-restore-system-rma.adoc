...
[role="lead"]
Vérifiez que les interfaces logiques (LIF) dépendent de leur port d'attache, vérifiez l'état du cluster, puis renvoyez la pièce défectueuse à NetApp pour terminer l'étape finale de la procédure de remplacement du contrôleur ASA A1K.
