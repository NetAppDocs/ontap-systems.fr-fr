...
summary: Arrêtez le contrôleur de votre système de stockage ASA A1K pour éviter la perte de données et garantir la stabilité du système lors du remplacement du châssis. 
---
= Arrêter le contrôleur pour remplacer le châssis - ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez le contrôleur de votre système de stockage ASA A1K pour éviter la perte de données et garantir la stabilité du système lors du remplacement du châssis.
