...
summary: 'Remplacez la pile de l"horloge temps réel, communément appelée pile bouton, dans votre système ASA A1K pour garantir que les services et applications qui dépendent d"une synchronisation horaire précise restent opérationnels.' 
---
= Remplacez la pile de l'horloge temps réel - ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la pile de l'horloge en temps réel (RTC), communément appelée pile bouton, dans votre système ASA A1K pour vous assurer que les services et applications reposant sur une synchronisation précise de l'heure restent opérationnels.

.Avant de commencer
* Vous pouvez utiliser cette procédure avec toutes les versions de ONTAP prises en charge par votre système.
* Assurez-vous que tous les autres composants du système fonctionnent correctement ; si ce n'est pas le cas, vous devez contacter le contact https://support.netapp.com["Support NetApp"].
