...
summary: Arrêtez le contrôleur de votre système de stockage ASA A1K pour éviter la perte de données et assurer la stabilité du système lors du remplacement du contrôleur. 
---
...
[role="lead"]
Arrêtez le contrôleur de votre système de stockage ASA A1K pour éviter la perte de données et assurer la stabilité du système lors du remplacement du contrôleur.
