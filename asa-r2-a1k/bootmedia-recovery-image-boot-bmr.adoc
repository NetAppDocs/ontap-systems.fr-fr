...
---
= Restaurer l'image ONTAP sur le support de démarrage - ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Passez à l'étape 6 pour réactiver le remboursement automatique s'il a été désactivé.
...
`key manager is configured.`
 a| 
Le chiffrement est installé.  Passez à l'étape 4 pour restaurer le gestionnaire de clés.
...
+
Passez à l'étape 5 pour réactiver le remboursement automatique s'il a été désactivé.
