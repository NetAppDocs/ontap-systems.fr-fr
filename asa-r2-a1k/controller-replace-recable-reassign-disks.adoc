...
summary: Replacez le contrôle des ressources de stockage sur le contrôleur de remplacement afin que votre système ASA A1K puisse reprendre son fonctionnement normal. 
---
...
[role="lead"]
Replacez le contrôle des ressources de stockage sur le contrôleur de remplacement afin que votre système ASA A1K puisse reprendre son fonctionnement normal. La procédure de restitution varie en fonction du type de cryptage utilisé par votre système : aucun cryptage ou cryptage Onboard Key Manager (OKM).
