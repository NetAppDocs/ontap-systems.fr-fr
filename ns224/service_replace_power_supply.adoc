...
+
L'illustration et le tableau de l'étape suivante montrent les deux vis à serrage à main (élément n° 1) et le connecteur du câble d'alimentation CC D-SUB (élément n° 2).

+
.. Dévisser les deux vis à serrage à main sur le connecteur du câble d'alimentation.
.. Débranchez le connecteur du câble d'alimentation du bloc d'alimentation et mettez-le de côté.
...
.. Serrez les deux vis moletées pour fixer le connecteur du câble d'alimentation à l'alimentation.
