...
summary: 'Installez l"étagère NS224 dans une armoire ou un rack de télécommunications, connectez les cordons d"alimentation et définissez l"ID de l"étagère pour votre système de fin de disponibilité.' 
---
= Installez un châssis NS224 sur votre système en fin de disponibilité
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installez l'étagère NS224 dans une armoire ou un rack de télécommunications, connectez les cordons d'alimentation et définissez l'ID de l'étagère pour votre système de fin de disponibilité.

.Avant de commencer
* Assurez-vous d'avoir un trombone dont une extrémité est redressée ou un stylo à bille à pointe fine.
+
...
.Et la suite ?
Après avoir installé votre étagère, link:hot-add-eoa-cable-overview.html["câblez votre étagère"].
