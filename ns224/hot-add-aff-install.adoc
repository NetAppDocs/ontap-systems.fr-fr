...
summary: 'Installez l"étagère NS224 dans une armoire ou un rack télécom, connectez les cordons d"alimentation et définissez l"ID de l"étagère pour votre système AFF.' 
---
= Installez un châssis NS224 sur votre système AFF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installez l'étagère NS224 dans une armoire ou un rack télécom, connectez les cordons d'alimentation et définissez l'ID de l'étagère pour votre système AFF.
...
.Et la suite ?
Après avoir installé votre étagère, link:hot-add-aff-cable-overview.html["câblez votre étagère"].
