...
summary: 'Vous pouvez supprimer à chaud un tiroir disque NS224 pour lequel des agrégats ont été supprimés des disques, dans une paire haute disponibilité qui est à disposition et transmet des données (les E/S sont en cours).' 
---
...
. Si vous retirez plusieurs étagères, répétez les étapes précédentes.
+
