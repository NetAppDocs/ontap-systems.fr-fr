...
summary: Vous pouvez remplacer une batterie RTC défectueuse dans un tiroir de disque NS224 sous tension, pendant que les E/S sont en cours de mise sous tension, sans interruption. 
---
= Remplacez la pile de l'horloge temps réel NS224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
