...
summary: 'Installez l"étagère NS224 dans une armoire ou un rack de télécommunications, connectez les cordons d"alimentation et définissez l"ID de l"étagère pour votre système ASA.' 
---
= Installez un châssis NS224 sur votre système ASA
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installez l'étagère NS224 dans une armoire ou un rack de télécommunications, connectez les cordons d'alimentation et définissez l'ID de l'étagère pour votre système ASA.
...
.Et la suite ?
Après avoir installé votre étagère,link:hot-add-asa-cable-overview.html["câblez votre étagère"].
