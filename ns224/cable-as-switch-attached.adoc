...
summary: 'Si vous disposez d"un système dans lequel les tiroirs disques NS224 doivent être câblés en tant que stockage à connexion par commutateur (pas de stockage à connexion directe), utilisez les informations fournies.' 
---
= Câblez les étagères NS224 en tant que stockage connecté à un commutateur
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
