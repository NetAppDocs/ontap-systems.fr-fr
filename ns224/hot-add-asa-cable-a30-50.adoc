...
summary: Câblez votre étagère NS224 à votre système ASA A30 ou ASA A50 de sorte que chaque étagère dispose de deux connexions à chaque contrôleur de la paire haute disponibilité. 
---
= Câblez un châssis NS224 à votre système ASA A30 ou ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Câblez votre étagère NS224 à votre système ASA A30 ou ASA A50 de sorte que chaque étagère dispose de deux connexions à chaque contrôleur de la paire haute disponibilité.

Vous pouvez ajouter à chaud jusqu'à deux étagères NS224 à une paire haute disponibilité ASA A30 ou ASA A50 lorsque stockage supplémentaire (à l'étagère interne) est nécessaire.
