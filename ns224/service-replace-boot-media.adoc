...
summary: 'Vous pouvez remplacer un support de démarrage défaillant dans un tiroir NS224. Le remplacement du support de démarrage peut s"effectuer sans interruption, alors que le tiroir disque est sous tension et que les E/S sont en cours.' 
---
= Remplacez le support de démarrage NS224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
