...
summary: 'Si vous avez désactivé l"attribution automatique des lecteurs, attribuez manuellement la propriété des lecteurs et réactivez l"attribution automatique des lecteurs pour votre système ASA.' 
---
= Complétez l'ajout à chaud de l'étagère NS224 pour votre système ASA
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
