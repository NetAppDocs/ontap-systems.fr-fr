...
summary: 'Pour remplacer à chaud un module d"alimentation de contrôleur de désétage, qui contient la batterie NVRAM10, localisez le module DCPM défectueux, retirez-le du châssis et installez le module DCPM de remplacement.' 
---
