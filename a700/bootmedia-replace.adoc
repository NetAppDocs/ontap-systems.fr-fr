...
summary: 'Remplacez le support de démarrage défectueux sur un module contrôleur AFF A700 . Le système AFF A700 ne prend en charge que les procédures de récupération manuelles du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
