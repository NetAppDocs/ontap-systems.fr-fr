...
summary: Pour rétablir le fonctionnement complet de votre système AFF A700, recâblez le stockage, restaurez la configuration de chiffrement du stockage NetApp si nécessaire et installez les licences pour le nouveau contrôleur. 
---
= Restauration complète du système - AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
