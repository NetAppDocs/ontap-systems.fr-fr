...
Le support de démarrage stocke un ensemble principal et un ensemble secondaire de fichiers image de démarrage que le système utilise lors de son démarrage. Le système AFF A700 et FAS9000 ne prend en charge que les procédures de récupération manuelle du support de démarrage.
