...
summary: Restaurez le chiffrement sur le support de démarrage de remplacement. Le système AFF A700 ne prend en charge que les procédures de récupération manuelle du support de démarrage. 
---
