...
summary: 'Démarrez l"image de récupération ONTAP à partir de la clé USB sur un système AFF A700 pour restaurer le support de démarrage. Le système AFF A700 ne prend en charge que les procédures de récupération manuelles du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
