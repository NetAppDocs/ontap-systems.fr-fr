...
summary: 'Éteignez le contrôleur défectueux sur un système AFF A700 après avoir terminé les vérifications de cryptage. Le système AFF A700 ne prend en charge que les procédures de récupération manuelles du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
= Arrêtez le contrôleur défectueux - AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
