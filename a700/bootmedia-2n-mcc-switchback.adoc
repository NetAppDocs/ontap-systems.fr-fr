...
summary: 'Après avoir terminé le remplacement du support de démarrage, effectuez l"opération de basculement MetroCluster pour ramener la configuration à son état de fonctionnement normal. Le système AFF A700 ne prend en charge que les procédures de récupération manuelle du support de démarrage.' 
---
