...
summary: 'Pour arrêter le nœud douteux, vous devez déterminer l"état du nœud et, le cas échéant, prendre le relais de façon à ce que le nœud en bonne santé continue à transmettre des données du stockage de nœud défaillant.' 
---
= Arrêtez le contrôleur défectueux - AFF 700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
