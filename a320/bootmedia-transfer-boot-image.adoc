...
summary: 'Le support de démarrage de remplacement que vous avez installé ne contient pas d"image de démarrage ; vous devez donc transférer une image de démarrage à l"aide d"une clé USB. Le système AFF A320 ne prend en charge que les procédures de récupération manuelle du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
...
[role="lead"]
Le support de démarrage de remplacement que vous avez installé ne contient pas d'image de démarrage ; vous devez donc transférer une image de démarrage à l'aide d'une clé USB. Le système AFF A320 ne prend en charge que les procédures de récupération manuelle du support de démarrage. La récupération automatique du support de démarrage n'est pas prise en charge.
