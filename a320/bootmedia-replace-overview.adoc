...
summary: 'Vous devez localiser le support de démarrage dans le module de commande, puis suivre les instructions pour le remplacer. Le système AFF A320 ne prend en charge que les procédures de récupération manuelle du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
...
[role="lead"]
Le système AFF A320 ne prend en charge que les procédures de récupération manuelle du support de démarrage.
