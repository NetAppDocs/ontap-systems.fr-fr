...
summary: Pour rétablir le fonctionnement complet de votre système AFF A320, restaurez la configuration de chiffrement du stockage NetApp si nécessaire, installez les licences pour le nouveau contrôleur et renvoyez la pièce défectueuse à NetApp. 
---
= Restauration complète du système : AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
