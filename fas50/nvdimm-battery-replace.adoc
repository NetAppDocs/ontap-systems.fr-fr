...
summary: 'Remplacez la batterie NV de votre système FAS50 lorsque la batterie commence à perdre ou à se décharger, car elle est chargée de préserver les données système critiques en cas de panne de courant. Le processus de remplacement implique l"arrêt du contrôleur défectueux, le retrait du module de contrôleur, le remplacement de la batterie NV, la réinstallation du module de contrôleur et le renvoi de la pièce défectueuse à NetApp.' 
---
= Remplacez la batterie NV - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la batterie NV de votre système FAS50 lorsque la batterie commence à perdre ou à se décharger, car elle est chargée de préserver les données système critiques en cas de panne de courant. Le processus de remplacement implique l'arrêt du contrôleur défectueux, le retrait du module de contrôleur, le remplacement de la batterie NV, la réinstallation du module de contrôleur et le renvoi de la pièce défectueuse à NetApp.
