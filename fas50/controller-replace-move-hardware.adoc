...
summary: 'Remplacez le contrôleur de votre système FAS50 en cas de défaillance matérielle. Le processus de remplacement implique le retrait du contrôleur défectueux, le déplacement des composants vers le contrôleur de remplacement, l"installation du contrôleur de remplacement et son redémarrage.' 
---
...
[role="lead"]
Remplacez le contrôleur de votre système FAS50 en cas de défaillance matérielle. Le processus de remplacement implique le retrait du contrôleur défectueux, le déplacement des composants vers le contrôleur de remplacement, l'installation du contrôleur de remplacement et son redémarrage.
