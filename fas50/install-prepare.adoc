...
summary: 'Préparez l"installation de votre système de stockage FAS50 en préparant le site, en déballez les boîtes et en comparant le contenu des boîtes au bordereau d"expédition. Enregistrez le système de stockage pour bénéficier des avantages du support.' 
---
