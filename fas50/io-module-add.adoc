...
summary: 'Ajoutez un module d"E/S à votre système de stockage FAS50 pour améliorer la connectivité réseau et augmenter la capacité de votre système à gérer le trafic de données.' 
---
...
[role="lead"]
Ajoutez un module d'E/S à votre système de stockage FAS50 pour améliorer la connectivité réseau et augmenter la capacité de votre système à gérer le trafic de données.

Vous pouvez ajouter un module d'E/S à votre système de stockage FAS50 lorsqu'il y a des emplacements disponibles ou lorsque tous les emplacements sont entièrement remplis (en retirant un module d'E/S existant et en installant un nouveau à la place).
