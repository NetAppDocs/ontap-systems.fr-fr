...
summary: 'Remplacez le châssis de votre système FAS50 en cas de défaillance matérielle. Le processus de remplacement implique le retrait des contrôleurs et des unités d"alimentation, le retrait des modules de cache, l"installation du châssis de remplacement et la réinstallation des composants du châssis.' 
---
= Remplacer le châssis - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le châssis de votre système FAS50 en cas de défaillance matérielle. Le processus de remplacement implique le retrait des contrôleurs et des unités d'alimentation, le retrait des modules de cache, l'installation du châssis de remplacement et la réinstallation des composants du châssis.
...
NOTE: Assurez-vous de savoir de quelle baie de lecteur chaque module de cache et chaque cache de lecteur ont été retirés car ils doivent être installés dans les mêmes baies de lecteur dans le châssis de remplacement.
...
.Et la suite ?
Après avoir remplacé le châssis FAS50 défectueux et réinstallé les composants dans celui-ci, vous devez link:chassis-replace-complete-system-restore-rma.html["terminez le remplacement du châssis"].
