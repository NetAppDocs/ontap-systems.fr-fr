...
summary: 'Remplacez le châssis de votre système de stockage FAS50 en cas de défaillance matérielle. Le processus de remplacement implique le retrait des contrôleurs et des unités d"alimentation, le retrait des modules de cache, l"installation du châssis de remplacement et la réinstallation des composants du châssis.' 
---
