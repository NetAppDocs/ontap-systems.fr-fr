...
summary: 'Remplacez la pile de l"horloge en temps réel (RTC), communément appelée pile bouton, dans votre système FAS50 pour vous assurer que les services et applications reposant sur une synchronisation précise de l"heure restent opérationnels.' 
---
...
[role="lead"]
Remplacez la pile de l'horloge en temps réel (RTC), communément appelée pile bouton, dans votre système FAS50 pour vous assurer que les services et applications reposant sur une synchronisation précise de l'heure restent opérationnels.
