...
summary: Avant de remplacer le châssis de votre système FAS50, veillez à respecter les exigences requises pour un remplacement réussi. Cela inclut la vérification du bon fonctionnement de tous les autres composants du système, la vérification que vous disposez du châssis de remplacement approprié et des outils nécessaires. 
---
...
[role="lead"]
Avant de remplacer le châssis de votre système FAS50, veillez à respecter les exigences requises pour un remplacement réussi. Cela inclut la vérification du bon fonctionnement de tous les autres composants du système, la vérification que vous disposez du châssis de remplacement approprié et des outils nécessaires.
