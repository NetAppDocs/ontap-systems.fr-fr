...
summary: Commencez à remplacer le contrôleur de votre système de stockage ASA C250 en arrêtant le contrôleur défectueux, en retirant et en remplaçant le contrôleur, en reconfigurant les paramètres du système et en vérifiant le fonctionnement du système. 
---
= Procédure de remplacement du contrôleur - ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le contrôleur de votre système de stockage ASA C250 en arrêtant le contrôleur défectueux, en le retirant et en le remplaçant, en restaurant la configuration du système et en redonnant le contrôle des ressources de stockage au contrôleur de remplacement.
