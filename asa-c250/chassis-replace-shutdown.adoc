...
[role="lead"]
Éteignez les contrôleurs de votre système de stockage AFF ASA C250 pour éviter toute perte de données et garantir la stabilité du système lors du remplacement du châssis.
...
.Et la suite ?
Après avoir éteint le contrôleur, vous devez link:chassis-replace-move-hardware.html["Déplacez le matériel vers le nouveau châssis"]
