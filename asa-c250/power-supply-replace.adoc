...
summary: 'Remplacez un bloc d"alimentation dans votre système ASA C250 en déconnectant le bloc d"alimentation cible de la source d"alimentation, en débranchant le câble d"alimentation, en retirant l"ancien bloc, en installant le bloc de remplacement, puis en le reconnectant à la source d"alimentation.' 
---
= Remplacement à chaud d'une alimentation - ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
--
Pour remplacer à chaud un bloc d'alimentation secteur, effectuez les étapes suivantes.
