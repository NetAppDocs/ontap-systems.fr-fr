...
---
= Restaurez et vérifiez la configuration du système - ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir terminé le remplacement du matériel et démarré votre système ASA C250 en mode Maintenance, vous devez vérifier la configuration système de bas niveau du contrôleur de remplacement et reconfigurer les paramètres système si nécessaire.
...
.Et la suite ?
Après avoir restauré et vérifié la configuration du système, vous devez link:controller-replace-recable-reassign-disks.html["recâbler le système et réaffecter les disques"].
