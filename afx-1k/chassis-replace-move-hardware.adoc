...
.Et la suite ?
Après avoir remplacé le châssis AFX 1K défectueux et réinstallé ses composants, terminez le link:chassis-replace-complete-system-restore-rma.html["remplacement du châssis"].
