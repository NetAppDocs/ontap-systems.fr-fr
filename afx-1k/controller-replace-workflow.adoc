...
summary: Commencez par remplacer le contrôleur de votre système de stockage AFX 1K en arrêtant le contrôleur défectueux, en retirant et en remplaçant le contrôleur, en reconfigurant les paramètres système et en vérifiant les opérations du système. 
---
= Flux de travail de remplacement du contrôleur - AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Commencez par remplacer le contrôleur de votre système de stockage AFX 1K en arrêtant le contrôleur défectueux, en retirant et en remplaçant le contrôleur, en restaurant la configuration du système et en vérifiant les opérations du système.
