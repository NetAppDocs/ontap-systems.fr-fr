...
summary: Renvoyez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système de stockage AFX 1K puisse reprendre son fonctionnement normal. 
---
= Rends le contrôleur - AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Renvoyez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système de stockage AFX 1K puisse reprendre son fonctionnement normal.  La procédure de restitution varie en fonction du type de cryptage utilisé par votre système : aucun cryptage ou cryptage Onboard Key Manager (OKM).
...
====
.Et la suite ?
Après avoir transféré la propriété des ressources de stockage au contrôleur de remplacement,link:controller-replace-restore-system-rma.html["terminer le remplacement du contrôleur"] .
