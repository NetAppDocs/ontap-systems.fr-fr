...
summary: 'Arrêtez le contrôleur de votre système de stockage AFX 1K lorsqu"il est altéré.  Avant d"effectuer une maintenance ou un remplacement de composant, il est essentiel d"arrêter le contrôleur en toute sécurité pour éviter la perte de données et garantir la stabilité du système.' 
---
= Arrêter le contrôleur altéré - AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez le contrôleur défectueux de votre système de stockage AFX 1K pour éviter la perte de données et garantir la stabilité du système lors du remplacement du contrôleur.
...
.Et la suite ?
Après avoir arrêté le contrôleur,link:controller-replace-move-hardware.html["remplacer le contrôleur"] .
