...
summary: 'Vous pouvez remplacer à chaud un module d"E/S Ethernet dans votre système de stockage AFX 1K si un module tombe en panne et si votre système de stockage répond à toutes les exigences de version ONTAP.' 
---
= Remplacer à chaud un module d'E/S - AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer à chaud un module d'E/S Ethernet dans votre système de stockage AFX 1K si un module tombe en panne et si votre système de stockage répond à toutes les exigences de version ONTAP.
