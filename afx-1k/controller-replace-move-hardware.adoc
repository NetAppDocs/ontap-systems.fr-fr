...
[role="lead"]
Remplacez le contrôleur de votre système de stockage AFX 1K lorsqu'une panne matérielle l'exige. Le processus de remplacement implique le retrait du contrôleur défectueux, le déplacement des composants vers le contrôleur de remplacement, l'installation du contrôleur de remplacement et son redémarrage.
...
.Et la suite ?
Après avoir remplacé le contrôleur AFX 1K défectueux,link:controller-replace-system-config-restore-and-verify.html["restaurer les paramètres du système"] .
