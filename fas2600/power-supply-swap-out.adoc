...
---
= Remplacez l'alimentation par un bloc d'alimentation - FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:https://youtu.be/fTOMwENNi9M["Vidéo sur le remplacement de l'alimentation électrique des systèmes AFF FAS2600"^]
