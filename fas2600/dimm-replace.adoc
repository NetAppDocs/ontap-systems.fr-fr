...
summary: 'Vous devez remplacer une barrette DIMM dans le contrôleur lorsque votre système de stockage rencontre des erreurs telles que des erreurs excessives de codes de correction d"erreurs corrigibles basées sur des alertes du Health Monitor ou des erreurs ECC non corrigibles, généralement causées par une seule défaillance de barrette DIMM empêchant le système de stockage de démarrer ONTAP.' 
---
= Remplacement d'un module DIMM - FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:https://youtu.be/ywwsMltvuXg["Vidéo sur le remplacement de modules DIMM avec AFF FAS2600"^]
...
. Vérifiez à nouveau la LED NVMEM.
