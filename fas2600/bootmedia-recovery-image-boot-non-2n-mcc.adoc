...
summary: 'Démarrez l"image de récupération ONTAP à partir de la clé USB sur un système FAS2600 pour restaurer le support de démarrage. Le système FAS2600 ne prend en charge que les procédures de récupération manuelle du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
= Démarrer l'image de restauration - FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
