...
+
image::../media/drw_asac800_weight_caution.png[avertissement poids drw asac800]

. Fixez les dispositifs de gestion des câbles (comme illustré).
+
image::../media/drw_asac800_install_cable_mgmt.png[drw asac800 installation de la gestion des câbles]
...
image:../media/oie_legend_icon_3_lp.png[""]
 a| 
Reliez les ports de gestion aux switchs réseau de gestion    image:../media/drw_asac800_mgmt_cabling.png["Illustration de l'emplacement des ports de gestion à l'arrière du système"]
...
1
 a| 
Reliez les ports 2a à 2d aux commutateurs hôte FC.image:../media/drw_asac800_fc_host_cabling.png[""]
...
1
 a| 
Reliez les ports e4a à e4d aux commutateurs du réseau hôte 10GbE.image:../media/drw_asac800_10gbe_host_cabling.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
Connectez les câbles du contrôleur A au tiroir :    image:../media/drw_asac800_1shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
Câble du contrôleur B vers le tiroir :    image:../media/drw_asac800_1shelf_cabling_b.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
Connectez les câbles du contrôleur A aux tiroirs.    image:../media/drw_asac800_2shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
Connectez les câbles du contrôleur B aux tiroirs.    image:../media/drw_asac800_2shelf_cabling_b.png[""]
...
+
image::../media/drw_console_connect_asac800.png[la console drw se connecte à asac800]

.. Connectez l'ordinateur portable ou la console au commutateur du sous-réseau de gestion.
+
image::../media/drw_client_mgmt_subnet_asac800.png[sous-réseau de gestion du client drw asac800]
