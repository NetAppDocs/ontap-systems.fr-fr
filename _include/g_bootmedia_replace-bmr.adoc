...
Pour remplacer le support de démarrage, vous devez retirer le contrôleur défectueux, retirer le support de démarrage défectueux, puis installer le support de démarrage de remplacement dans le contrôleur défectueux.
