...
Pour remplacer le support de démarrage, vous devez retirer le module de gestion du système de l'arrière du système, retirer le support de démarrage défectueux, installer le support de démarrage de remplacement dans le module de gestion du système et transférer l'image ONTAP d'une clé USB vers le support de démarrage de remplacement.
...
.. Appuyez sur le bouton CAM de gestion du système. Le levier de came s'éloigne du boîtier.
