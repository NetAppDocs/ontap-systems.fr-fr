...
+
** Si <lno-DARE> ou <1Ono-DARE> s'affiche dans le résultat de la commande, le système ne prend pas en charge NVE, passez à l'étape <<Arrêtez le contrôleur défaillant>>.
