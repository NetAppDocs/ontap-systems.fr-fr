...
+
image::../media/drw_a800_close_air_duct.png[Fermeture du schéma de conduit d'air du module de contrôleur AFF A70-90]
...
**** `bootarg.init.san_optimized` Pour AFF A220 et baies 100 % SAN
