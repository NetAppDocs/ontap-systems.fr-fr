...
summary: Le support de démarrage de votre AFF C250 stocke le micrologiciel et les données de configuration essentiels. Le processus de remplacement consiste à retirer le module contrôleur, à retirer le support de démarrage défectueux, à installer le support de démarrage de remplacement dans le module contrôleur, puis à réinstaller le module contrôleur. 
---
= Remplacez le support de démarrage pour la récupération automatique du démarrage - AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
