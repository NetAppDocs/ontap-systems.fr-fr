...
[role="lead"]
Avant de remplacer le châssis de votre AFF C250, assurez-vous de respecter les conditions requises pour un remplacement réussi. Cela inclut la vérification du bon fonctionnement de tous les autres composants du système, la confirmation que vous disposez des identifiants d'administrateur local pour ONTAP, du châssis de remplacement adéquat et des outils nécessaires.
