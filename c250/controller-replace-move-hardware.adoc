...
[role="lead"]
Le AFF C250 est doté d'un périphérique de démarrage sous le conduit d'air du module de contrôleur. Vous devez le déplacer du module de contrôleur défaillant vers le module de contrôleur de remplacement.
