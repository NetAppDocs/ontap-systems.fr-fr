...
[role="lead"]
Remplacez le châssis de votre AFF C250 lorsque cela est nécessaire en cas de défaillance matérielle. La procédure de remplacement consiste à retirer les contrôleurs et les blocs d'alimentation (PSU), à retirer les disques, à installer le châssis de remplacement, puis à réinstaller les composants du châssis.
...
.Et la suite ?
Après avoir remplacé le châssis défectueux AFF C250 et réinstallé les composants, vous devez link:chassis-replace-complete-system-restore-rma.html["terminez le remplacement du châssis"]
