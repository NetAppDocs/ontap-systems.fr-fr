...
---
= Recâblage du système et réaffectation des disques - AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir terminé la restauration et vérifié la configuration du système AFF C250, vous devez recâbler le système et réaffecter les disques.
...
.Et la suite ?
Après avoir recâblé le système et réattribué les disques, vous devez link:controller-replace-restore-system-rma.html["terminez le remplacement du contrôleur"].
