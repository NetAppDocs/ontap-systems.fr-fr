...
summary: Après avoir installé le nouveau périphérique de démarrage dans votre système AFF C250, vous pouvez lancer le processus de récupération automatisé du support de démarrage pour restaurer la configuration à partir du nœud partenaire. 
---
= Récupération automatisée du support de démarrage à partir du nœud partenaire - AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
