...
---
= Déplacement et remplacement matériel - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Vous pouvez utiliser la vidéo suivante ou les étapes tabulées pour remplacer le châssis ; elle suppose le retrait et le remplacement du cadre :
