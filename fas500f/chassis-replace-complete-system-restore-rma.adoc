...
---
= Terminez le remplacement du châssis - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Redémarrez les contrôleurs, vérifiez l'état du système et renvoyez la pièce défectueuse à NetApp pour compléter l'étape finale de la procédure de remplacement du châssis FAS500f.
