...
---
= Remplacez le support de démarrage et préparez-vous à une récupération manuelle du menu de démarrage - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
