...
---
= Recâblage du système et réaffectation de disques - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir terminé la restauration et vérifié la configuration du système FAS500f, vous devez recâbler le système et réaffecter les disques.
