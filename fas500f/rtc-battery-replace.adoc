...
summary: 'Vous remplacez la pile de l"horloge temps réel dans le module de contrôle afin que les services et applications de votre système qui dépendent d"une synchronisation horaire précise continuent de fonctionner.' 
---
...
Vous pouvez utiliser la vidéo suivante ou les étapes tabulées pour remplacer la batterie RTC :
...
+
image::../media/drw_a250_remove_rtc_batt.png[Comment retirer la batterie RTC]
...
|===
 ...
 a| 
image:../media/icon_round_1.png["Légende numéro 1"]
| Tirez doucement la languette hors du logement de la batterie. REMARQUE : une traction agressive risque de déplacer l'onglet. 
...
NOTE: Notez la polarité de la batterie.
...
+
image::../media/drw_a250_install_rtc_batt.png[Installation de la batterie RTC]
