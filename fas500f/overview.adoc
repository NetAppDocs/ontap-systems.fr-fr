...
summary: Spécifications clés du système de stockage FAS500f 
---
= Spécifications clés pour FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Voici une sélection de spécifications pour le FAS500f. Consultez  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) pour obtenir la liste complète des spécifications du FAS500f. Cette page présente les caractéristiques d'une seule paire haute disponibilité.



=== Spécifications clés pour FAS500f

Configuration de la plateforme : FAS500f Single Chassis HA Pair
