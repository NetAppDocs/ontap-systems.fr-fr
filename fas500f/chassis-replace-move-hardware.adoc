...
[role="lead"]
Remplacez le châssis de votre FAS500f lorsque cela est nécessaire en cas de défaillance matérielle. Le processus de remplacement consiste à retirer les contrôleurs et les blocs d'alimentation (PSU), à retirer les disques, à installer le châssis de remplacement, puis à réinstaller les composants du châssis.
...
.Et la suite ?
Après avoir remplacé le châssis FAS500f défectueux et réinstallé les composants, vous devez link:chassis-replace-complete-system-restore-rma.html["terminez le remplacement du châssis"]
