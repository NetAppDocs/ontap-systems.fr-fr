...
---
= Restaurez et vérifiez la configuration du système - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir effectué le remplacement du matériel et démarré votre système FAS500f en mode Maintenance, vous devez vérifier la configuration système de bas niveau du contrôleur de remplacement et reconfigurer les paramètres système si nécessaire.
