...
summary: 'Ajoutez un module d"E/S à votre système de stockage ASA C30 pour améliorer la connectivité réseau et étendre la capacité de votre système à gérer le trafic de données.' 
---
= Ajouter un module d'E/S - ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ajoutez un module d'E/S à votre système de stockage ASA C30 pour améliorer la connectivité réseau et étendre la capacité de votre système à gérer le trafic de données.
