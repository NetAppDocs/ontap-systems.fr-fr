...
summary: 'Remplacez le châssis de votre système de stockage ASA C30 lorsqu"une panne matérielle l"exige. Le processus de remplacement implique le retrait des contrôleurs, le retrait des lecteurs, l"installation du châssis de remplacement et la réinstallation des composants du châssis.' 
---
= Remplacez le châssis - ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le châssis de votre système de stockage ASA C30 lorsqu'une panne matérielle l'exige. Le processus de remplacement implique le retrait des contrôleurs, le retrait des lecteurs, l'installation du châssis de remplacement et la réinstallation des composants du châssis.
