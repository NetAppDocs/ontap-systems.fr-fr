...
summary: Après avoir installé le nouveau périphérique de support de démarrage dans votre système de stockage ASA C30, vous pouvez démarrer le processus de récupération automatique du support de démarrage pour restaurer la configuration à partir du nœud sain. 
---
= Restaurer l'image ONTAP sur le support de démarrage - ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir installé le nouveau périphérique de support de démarrage dans votre système de stockage ASA C30, vous pouvez démarrer le processus de récupération automatique du support de démarrage pour restaurer la configuration à partir du nœud sain.
