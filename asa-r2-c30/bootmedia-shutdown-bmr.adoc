...
summary: Arrêtez le contrôleur défectueux de votre système de stockage ASA C30 pour éviter la perte de données et assurer la stabilité du système lors du remplacement du support de démarrage. 
---
= Arrêtez le contrôleur pour remplacer le support de démarrage - ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez le contrôleur défectueux de votre système de stockage ASA C30 pour éviter la perte de données et assurer la stabilité du système lors du remplacement du support de démarrage.
