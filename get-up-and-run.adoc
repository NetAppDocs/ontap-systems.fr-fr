...
* link:https://docs.netapp.com/us-en/ontap-systems-switches/afx/index.html["Commutateurs AFX"^]
* link:https://review.docs.netapp.com/us-en/ontap-systems-switches/cluster/index.html["Commutateurs de cluster"^]
* link:https://review.docs.netapp.com/us-en/ontap-systems-switches/storage/index.html["Commutateurs de stockage"^]
* link:https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-9336c-fx2-shared/install-9336c-shared.html["Commutateurs partagés"^]
...
[role="quick-margin-list"]
* link:aff-aseries/index.html["Systèmes AFF A-Series"]
* link:aff-cseries/index.html["Systèmes AFF C-Series"]
* link:allsan-landing/index.html["Systèmes ASA"]
* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/install-setup-workflow.html["Systèmes AFX"]
* https://docs.netapp.com/us-en/asa-r2/install-setup/install-setup-workflow.html["Systèmes ASA r2"]
...
* Pour les déploiements ONTAP avec MetroCluster , voir https://docs.netapp.com/us-en/ontap-metrocluster/["Configurez MetroCluster avec ONTAP"^] .
