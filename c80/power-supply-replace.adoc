...
summary: 'Remplacez un bloc d"alimentation CA ou CC de votre système AFF C80 en cas de panne ou de panne, en vous assurant que votre système continue à recevoir l"alimentation requise pour un fonctionnement stable.' 
---
