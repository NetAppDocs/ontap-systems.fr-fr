...
summary: 'Remplacez le bloc d"alimentation CA ou CC de votre AFF C80 lorsqu"il tombe en panne ou présente un dysfonctionnement, afin de garantir que votre système continue de recevoir l"alimentation nécessaire pour un fonctionnement stable. Le processus de remplacement consiste à déconnecter le bloc d"alimentation défectueux de la source d"alimentation, à débrancher le câble d"alimentation, à remplacer le bloc défectueux, puis à le reconnecter à la source d"alimentation.' 
---
