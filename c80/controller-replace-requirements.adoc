...
.Et la suite ?
Après avoir vérifié les conditions requises pour remplacer votre contrôleur AFF C80, vous devez link:controller-replace-shutdown.html["arrêtez le contrôleur défectueux"].
