...
summary: Arrêtez le contrôleur défectueux de votre système de stockage AFF C80 pour éviter la perte de données et maintenir la stabilité du système pendant le processus de récupération du support de démarrage manuel. 
---
= Arrêter le contrôleur pour la récupération manuelle du support de démarrage - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
