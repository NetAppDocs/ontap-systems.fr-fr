...
[role="lead"]
Arrêtez le contrôleur défectueux de votre système de stockage AFF C80 pour éviter la perte de données et maintenir la stabilité du système pendant le processus de récupération du support de démarrage manuel.
