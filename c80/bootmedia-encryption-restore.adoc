...
summary: 'Restaurez le chiffrement sur le support de démarrage de remplacement de votre système AFF C80 pour assurer une protection continue des données. Ce processus implique de vérifier la disponibilité de la clé, de rétablir les paramètres de cryptage et de confirmer l"accès sécurisé à vos données.' 
---
= Restaurer le chiffrement - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaurez le chiffrement sur le support de démarrage de remplacement de votre système AFF C80 pour assurer une protection continue des données. Ce processus implique de vérifier la disponibilité de la clé, de rétablir les paramètres de cryptage et de confirmer l'accès sécurisé à vos données.
