...
summary: 'Le support de démarrage de votre système AFF C80 stocke les données essentielles du micrologiciel et de la configuration. Si le support d"amorçage échoue, vous devez débrancher le module de contrôleur, retirer le module de gestion du système, retirer le support d"amorçage défectueux et remplacer le support d"amorçage dans le module de gestion du système.' 
---
