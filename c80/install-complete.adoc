...
summary: 'Effectuez l"installation et la configuration du système de stockage à l"aide de la détection de cluster via une seule connexion au commutateur et à l"ordinateur portable, ou en vous connectant directement à un contrôleur du système de stockage, puis au commutateur de gestion.' 
---
...
[role="lead"]
Après avoir activé votre système de stockage AFF C80, vous pouvez détecter le réseau en cluster et configurer un cluster ONTAP.
