...
summary: 'Vous pouvez remplacer un module d"E/S défectueux dans votre système de stockage AFF C80 par le même type de module d"E/S ou par un module d"E/S d"un autre type. Vous pouvez également ajouter un module d"E/S dans un système avec des emplacements vides.' 
---
...
+
Le remplacement à chaud d'un module d'E/S permet de remplacer un module défaillant sans arrêter le système, minimisant l'interruption et maintenant la disponibilité du système.
