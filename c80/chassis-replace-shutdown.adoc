...
summary: Arrêtez le contrôleur de votre système de stockage AFF C80 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du châssis. 
---
= Arrêtez le contrôleur pour remplacer le châssis - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez le contrôleur de votre système de stockage AFF C80 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du châssis.
