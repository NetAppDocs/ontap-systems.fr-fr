...
summary: 'Vous devez remplacer un disque lorsque le système de stockage envoie un message d"avertissement à la console système pour indiquer qu"un disque est en panne. De plus, le voyant de panne du panneau d"affichage de l"opérateur et le voyant de panne du disque défectueux sont allumés.' 
---
