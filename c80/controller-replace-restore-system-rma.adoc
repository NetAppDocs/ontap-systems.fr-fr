...
summary: 'Vérifiez que les interfaces logiques signalent leur port de base, effectuez un contrôle de l"état du cluster et renvoyez la pièce défectueuse à NetApp pour terminer l"étape finale du workflow de remplacement du contrôleur AFF C80.' 
---
...
[role="lead"]
Vérifiez que les interfaces logiques signalent leur port de base, effectuez un contrôle de l'état du cluster et renvoyez la pièce défectueuse à NetApp pour terminer l'étape finale du workflow de remplacement du contrôleur AFF C80.
