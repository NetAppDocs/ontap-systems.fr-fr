...
[role="lead"]
Remplacez le châssis de votre système AFF C80 lorsqu'une panne matérielle l'exige. Le processus de remplacement implique le retrait des contrôleurs et des blocs d'alimentation (PSU), le retrait des lecteurs, l'installation du châssis de remplacement et la réinstallation des composants du châssis.
...
== Étape 3 : Remplacez le châssis et installez les composants

Retirez le châssis endommagé, installez le châssis de remplacement et réinstallez tous les composants.
...
.Et la suite ?
Après avoir remplacé le châssis endommagé et réinstallé les composants,link:chassis-replace-complete-system-restore-rma.html["terminez le remplacement du châssis"] .
