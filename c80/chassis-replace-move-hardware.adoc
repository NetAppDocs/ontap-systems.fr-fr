...
summary: 'Remplacez le châssis de votre système AFF C80 en cas de défaillance matérielle. Le processus de remplacement implique le retrait des blocs d"alimentation, le retrait du châssis existant, l"installation du nouveau châssis et la réinstallation des composants du châssis.' 
---
...
[role="lead"]
Remplacez le châssis de votre système AFF C80 en cas de défaillance matérielle. Le processus de remplacement implique le retrait des blocs d'alimentation, le retrait du châssis existant, l'installation du nouveau châssis et la réinstallation des composants du châssis.
