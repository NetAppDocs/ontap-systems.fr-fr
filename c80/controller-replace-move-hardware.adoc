...
---
= Remplacer le contrôleur - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le contrôleur de votre système AFF C80 en cas de défaillance matérielle. Ce processus implique le retrait du contrôleur défectueux, le déplacement des composants vers le contrôleur de remplacement, l'installation du contrôleur de remplacement et le redémarrage du système.
...
.Et la suite ?
Après avoir remplacé le contrôleur AFF C80 défectueux, vous devez :link:controller-replace-system-config-restore-and-verify.html["restaurez la configuration du système"] .
