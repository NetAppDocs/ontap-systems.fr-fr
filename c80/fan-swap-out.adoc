...
summary: 'Remplacez un module de ventilation de votre système AFF C80 lorsqu"un ventilateur tombe en panne ou ne fonctionne pas efficacement, ce qui peut affecter le refroidissement du système et les performances globales.' 
---
...
[role="lead"]
Remplacez un module de ventilation de votre système AFF C80 lorsqu'un ventilateur tombe en panne ou ne fonctionne pas efficacement, ce qui peut affecter le refroidissement du système et les performances globales.
