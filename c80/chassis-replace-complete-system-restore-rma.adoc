...
summary: 'Redémarrez les contrôleurs, vérifiez l"état du système et renvoyez la pièce défectueuse à NetApp pour terminer l"étape finale du workflow de remplacement du châssis AFF C80.' 
---
...
[role="lead"]
Redémarrez les contrôleurs, vérifiez l'état du système et renvoyez la pièce défectueuse à NetApp pour terminer l'étape finale du workflow de remplacement du châssis AFF C80.
