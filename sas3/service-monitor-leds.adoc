...
---
= Surveillez les voyants LED des tiroirs DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Orange fixe
 a| 
Une erreur s'est produite avec le fonctionnement d'une ou plusieurs FRU : le tiroir disque, les disques, les modules IOM12, IOM12B ou IOM12C, ou les alimentations.
...
Le voyant de localisation situé sur le panneau d'affichage de l'opérateur et sur les deux modules IOM12, IOM12B ou IOM12C s'allume lorsque cette fonction LED est activée. Les voyants de localisation s'éteignent automatiquement après 30 minutes.
...
== LED du module IOM12, IOM12B ou IOM12C

Les LED du module IOM12, IOM12B ou IOM12C indiquent si le module fonctionne normalement, s'il est prêt pour le trafic d'E/S et s'il existe des problèmes matériels.

Le tableau suivant décrit les LED des modules IOM12, IOM12B ou IOM12C associées à la fonction du module et à la fonction de chaque port SAS sur le module.

Le module IOM12, IOM12B ou IOM12C est utilisé dans les tiroirs disques DS460C, DS224C et DS212C.
...
Orange fixe
 a| 
Fonctionnement du module IOM12, IOM12B ou IOM12C : Une erreur s’est produite lors du fonctionnement du module IOM12, IOM12B ou IOM12C.
...
Bleu fixe
 a| 
L'administrateur système a activé cette fonction LED pour faciliter la localisation physique du tiroir disque avec le module IOM12, IOM12B ou IOM12C en défaillance.
