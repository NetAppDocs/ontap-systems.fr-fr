...
---
= Remplacez à chaud un disque dans un tiroir disque DS212C ou DS224C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer à chaud un disque défaillant dans un tiroir disque DS224C ou DS212C équipé de modules IOM12, IOM12B ou IOM12C.
