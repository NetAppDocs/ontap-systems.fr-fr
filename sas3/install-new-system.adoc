...
summary: 'Si votre nouveau système n"est pas installé dans une armoire, vous devez installer et câbler les tiroirs disques dans une baie.' 
---
= Installez et câblez un tiroir disque DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Les tiroirs disques avec modules IOM12, IOM12B ou IOM12C sont livrés avec des ID de tiroir préréglés sur 00.
+
...
* Si vous ne configurez pas le système pour utiliser l'attribution automatique de la propriété des disques lors de l'installation et de la configuration du système, vous devrez attribuer manuellement la propriété des disques.
