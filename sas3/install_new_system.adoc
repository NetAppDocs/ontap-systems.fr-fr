...
Vous devez répondre aux exigences décrites dans la section  for installing and cabling disk shelves with IOM12 modules for a new system installation et ont installé les tiroirs disques sur le rack.
