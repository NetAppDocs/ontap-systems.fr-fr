...
summary: 'Vous pouvez utiliser une feuille de calcul de câblage pour définir les paires de ports SAS du contrôleur que vous pouvez utiliser pour câbler les contrôleurs à des piles de tiroirs disques afin d"obtenir une connectivité multipathed.' 
---
= Feuille de câblage pour la connectivité multivoies DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez utiliser une feuille de câblage pour définir les paires de ports SAS de contrôleur que vous pouvez utiliser pour connecter les contrôleurs aux piles de tiroirs disques afin d'obtenir une connectivité multipathed dans une paire haute disponibilité ou une configuration à contrôleur unique. Vous pouvez également utiliser la feuille de câblage complétée pour vous guider lors du câblage des connexions multipathed pour votre configuration.
