...
summary: 'Définissez les paires de ports SAS du contrôleur que vous pouvez utiliser pour câbler les contrôleurs à des piles de tiroirs disques afin d"assurer une connectivité à quatre chemins dans une paire haute disponibilité ou une configuration à contrôleur unique.' 
---
= Feuille de câblage pour la connectivité à quatre chemins DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez utiliser une feuille de calcul de câblage pour définir les paires de ports SAS du contrôleur que vous pouvez utiliser pour connecter les contrôleurs à des tiroirs disques équipés de modules IOM12, IOM12B ou IOM12C afin d'obtenir une connectivité à quatre chemins dans une paire haute disponibilité ou une configuration à contrôleur unique. Vous pouvez également utiliser la feuille de calcul complétée pour vous guider lors du câblage des connexions à quatre chemins pour votre configuration.
...
+
Une configuration avec deux HBA SAS à quatre ports et deux piles de tiroirs disques avec des modules IOM12, IOM12B ou IOM12C est utilisée pour les exemples de feuilles de calcul.
