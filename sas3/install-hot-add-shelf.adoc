...
summary: 'Vous pouvez ajouter à chaud un ou plusieurs tiroirs disques à une pile de tiroirs disques existante ou ajouter à chaud une pile d"un ou plusieurs tiroirs disques directement à un HBA SAS ou à un port SAS intégré au contrôleur.' 
---
= Ajoutez à chaud un tiroir disque DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez ajouter à chaud un ou plusieurs tiroirs disques à une pile de tiroirs disques existante ou ajouter à chaud une pile d'un ou plusieurs tiroirs disques directement à un HBA SAS ou à un port SAS intégré au contrôleur.
...
* Assurez-vous que votre système répond à certaines exigences avant d'ajouter à chaud des tiroirs disques avec des modules IOM12, IOM12B ou IOM12C :
+
...
+
** Si vous ajoutez à chaud un tiroir disque avec des modules IOM12, IOM12B ou IOM12C à une pile existante (de tiroirs disques avec des modules IOM12, IOM12B ou IOM12C), vous pouvez ajouter à chaud le tiroir disque à l'une ou l'autre extrémité — le premier ou le dernier tiroir disque logique — de la pile.
+
...
** Les tiroirs disques avec modules IOM12, IOM12B ou IOM12C doivent être dans leur propre pile unique.
...
+
Vous désactivez l'attribution automatique de la propriété des disques avant de câbler les baies de disques ajoutées à chaud, puis vous la réactivez plus tard dans cette procédure après avoir câblé les baies de disques ajoutées à chaud.
...
. Si vous ajoutez à chaud une pile de baies de disques directement à un contrôleur, suivez les sous-étapes suivantes ; sinon, passez à l’étape suivante.
+
