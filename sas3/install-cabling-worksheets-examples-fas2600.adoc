...
---
= Fiches de câblage pour les tiroirs disques DS212C, DS224C ou DS460C avec plateformes de stockage internes
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez utiliser les fiches de câblage contrôleur-vers-pile complétées et les exemples de câblage pour câbler les plateformes avec stockage interne. Cela s'applique aux tiroirs équipés de modules IOM12, IOM12B ou IOM12C.
...
NOTE: Cette section ne s'applique pas aux systèmes FAS2820.
