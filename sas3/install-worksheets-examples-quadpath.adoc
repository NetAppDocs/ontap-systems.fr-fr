...
+
image::../media/drw_controller_to_stack_quad_pathed_connectivity_key.gif[Touche couleur pour une connectivité à quatre chemins]
...
image::../media/drw_qpha_slots_1_and_2_two_4porthbas_two_stacks_nau.gif[Quuad-path HA avec deux HBA SAS à quatre ports et deux piles à plusieurs tiroirs]
