...
---
= Feuille de câblage pour une configuration de paire haute disponibilité à quatre chemins DS212C, DS224C ou DS460C avec deux HBA SAS à quatre ports
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez utiliser la feuille de calcul de câblage contrôleur-vers-tiroir complétée et l'exemple de câblage pour connecter une configuration paire haute disponibilité à quatre chemins comportant deux cartes HBA SAS à quatre ports. Ceci s'applique aux tiroirs équipés de modules IOM12, IOM12B ou IOM12C.
