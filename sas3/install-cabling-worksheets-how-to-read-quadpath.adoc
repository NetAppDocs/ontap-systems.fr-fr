...
summary: 'Utilisez cet exemple pour vous guider dans la lecture et l"application d"une feuille de travail remplie pour câbler des piles de tiroirs disques afin d"obtenir une connectivité à quatre chemins.' 
---
= Consultez une fiche technique pour câbler les connexions contrôleur-vers-pile pour la connectivité à quatre chemins des DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez utiliser cet exemple pour vous guider sur la façon de lire et d'appliquer une feuille de calcul remplie aux piles de tiroirs disques avec des modules IOM12, IOM12B ou IOM12C pour une connectivité à quatre chemins.
