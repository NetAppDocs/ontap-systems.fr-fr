...
summary: 'Modifiez l"identifiant d"un tiroir disque dans un système lorsque ONTAP n"est pas encore en cours d"exécution, lors de l"ajout à chaud d"un tiroir disque avant son raccordement au système, ou lorsque ONTAP est en cours d"exécution et que tous les disques du tiroir sont non attribués, de rechange ou font partie d"agrégats hors ligne.' 
---
= Modifier l'identifiant d'un tiroir disque DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez modifier l'identifiant d'une baie DS212C, DS224C ou DS460C lorsque ONTAP n'est pas encore en fonctionnement ou lors de l'ajout à chaud d'une baie avant son raccordement au système. Vous pouvez également modifier l'identifiant d'une baie lorsque ONTAP est opérationnel (les modules de contrôleur sont disponibles pour fournir des données) et que tous les disques de la baie sont non attribués, de rechange ou font partie d'un ou plusieurs agrégats hors ligne.
