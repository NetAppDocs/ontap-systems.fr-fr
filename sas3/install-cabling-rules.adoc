...
image::../media/drw_fas2600_mpha_domain_example_IEOPS-1172.svg[connectivité de domaine du port de stockage interne 0b/0b1]
...
image::../media/drw_fas2800_concept_tpha_IEOPS-950.svg[Connectivité haute disponibilité à trois chemins d'accès]
...
image::../media/drw_sas3_ports_on_fas2800_IEOPS-946.svg[Ports sas externes FAS2800]
