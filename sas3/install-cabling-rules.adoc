...
summary: 'Les tiroirs disques avec modules IOM12, IOM12B ou IOM12C peuvent être câblés en configurations de paire haute disponibilité ou de contrôleur unique (pour les plateformes prises en charge).' 
---
= Règles et concepts de câblage SAS pour les tiroirs DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Les tiroirs DS212C, DS224C et DS460C avec modules IOM12, IOM12B ou IOM12C peuvent être câblés en paire haute disponibilité et en configurations à contrôleur unique (pour les plateformes prises en charge) en appliquant les règles de câblage SAS : règles de configuration, règles de numérotation des emplacements de contrôleur, règles de connexion tiroir à tiroir, règles de connexion contrôleur à pile et, le cas échéant, règles de câble optique mini-SAS HD SAS.


NOTE: Les règles de câblage SAS relatives à la numérotation des emplacements de contrôleur, aux règles de connexion entre tiroirs et aux règles de connexion contrôleur-vers-pile décrites dans ce guide sont les mêmes règles qui s'appliquent à tous les tiroirs disques SAS, qu'ils soient équipés de modules IOM12, IOM12B ou IOM12C. Cependant, les informations de ce guide sont spécifiques aux caractéristiques uniques des tiroirs disques avec modules IOM12, IOM12B ou IOM12C et à leur utilisation dans les configurations prises en charge.

Les règles de câblage SAS concernant les règles de configuration et les règles relatives aux câbles optiques mini-SAS HD SAS décrites dans ce guide sont spécifiques aux tiroirs disques avec modules IOM12, IOM12B ou IOM12C.
...
Les tiroirs disques avec modules IOM12, IOM12B ou IOM12C sont pris en charge sur certains types de configurations de paire haute disponibilité et de contrôleur unique.
