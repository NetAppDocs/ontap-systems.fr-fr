...
summary: Vous pouvez utiliser les feuilles de calcul et les exemples de câblage contrôleur-empilement pour câbler votre paire haute disponibilité en tant que configuration multipath HA. 
---
= Fiches de câblage pour les configurations de paire haute disponibilité multipath DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Ceci s'applique aux tiroirs disques avec modules IOM12, IOM12B ou IOM12C.
