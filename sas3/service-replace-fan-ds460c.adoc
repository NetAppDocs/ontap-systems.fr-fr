...
summary: Si un module de ventilateur tombe en panne dans un tiroir disque DS460C, vous devez le remplacer dès que possible pour garantir un refroidissement adéquat du tiroir. 
---
= Remplacez un module de ventilateur DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
