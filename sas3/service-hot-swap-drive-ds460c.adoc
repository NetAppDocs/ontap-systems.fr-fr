...
---
= Remplacez à chaud un disque dans un tiroir disque DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer à chaud un disque défaillant dans un tiroir disque DS460C avec des modules IOM12, IOM12B ou IOM12C.
