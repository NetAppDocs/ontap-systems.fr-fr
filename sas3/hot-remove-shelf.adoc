...
summary: 'Vous pouvez retirer à chaud un tiroir disque lorsqu"il doit être retiré ou remplacé d"un système sous tension et que des opérations d"E/S sont en cours.' 
---
= Retirez à chaud un tiroir disque DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez retirer à chaud un tiroir disque lorsqu'il doit être retiré ou remplacé sur un système sous tension pendant des opérations d'E/S. Vous pouvez retirer à chaud un ou plusieurs tiroirs disques depuis n'importe quel emplacement d'une pile de tiroirs disques, ou retirer une pile de tiroirs disques.
...
.. Passez directement à la réactivation de l'attribution automatique si nécessaire (plusieurs étapes ci-dessous).
...
+
** Les modules IOM12, IOM12B ou IOM12C sont disposés côte à côte comme dans un tiroir disque DS224C ou DS212C ; si vous avez un DS460C, les modules IOM12, IOM12B ou IOM12C sont disposés l'un au-dessus de l'autre.
