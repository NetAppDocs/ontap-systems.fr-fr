...
---
= Déplacement et remplacement du matériel - AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Après avoir installé le module de contrôleur et tout autre composant dans le nouveau châssis, vous devez le démarrer à un état permettant d'exécuter le test de diagnostic d'interconnexion.
