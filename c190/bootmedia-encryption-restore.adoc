...
summary: 'Restaurez la configuration de chiffrement sur le support de démarrage de remplacement pour un système AFF C190 . Le système AFF C190 ne prend en charge que les procédures de récupération manuelles du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
= Restaurer le chiffrement - AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
