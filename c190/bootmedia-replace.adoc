...
summary: 'Remplacez le support de démarrage défectueux sur un module contrôleur AFF C190 . Le système AFF C190 ne prend en charge que les procédures de récupération manuelles du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
