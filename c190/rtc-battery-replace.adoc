...
Pour remplacer la batterie RTC, vous devez la localiser à l'intérieur du module de contrôleur, puis suivre la séquence spécifique des étapes.

. Localisez la batterie RTC.
+
image::../media/drw_2600_rtc_battery.gif[Remplacer la batterie RTC]
...
. Terminez la réinstallation du module de contrôleur. Le module de contrôleur commence à démarrer dès qu'il est complètement inséré dans le châssis.
+
