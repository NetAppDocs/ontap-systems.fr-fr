...
summary: 'Remplacez une barrette DIMM dans votre module contrôleur AFF A220 lorsque votre système enregistre un nombre croissant de codes de correction d"erreurs corrigibles ou d"erreurs ECC non corrigibles. Le non-remplacement d"une barrette DIMM défectueuse peut entraîner un blocage système.' 
---
= Remplacez un module DIMM - AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
