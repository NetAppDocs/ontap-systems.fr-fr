...
summary: Le support de démarrage contient un ensemble principal et un ensemble secondaire de fichiers système que le système utilise lors du démarrage. Le système AFF A220 ne prend en charge que les procédures de récupération manuelles du support de démarrage. 
---
= Présentation du remplacement du support de démarrage - AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Le système AFF A220 ne prend en charge que les procédures de récupération manuelles du support de démarrage.
