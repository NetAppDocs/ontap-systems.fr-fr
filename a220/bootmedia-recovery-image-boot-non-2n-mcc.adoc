...
summary: 'Vous devez démarrer l"image ONTAP à partir de la clé USB, restaurer le système de fichiers et vérifier les variables d"environnement. Le système AFF A220 ne prend en charge que les procédures de récupération manuelles du support de démarrage.' 
---
