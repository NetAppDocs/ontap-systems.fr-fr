...
summary: 'Restaurez le chiffrement sur le support de démarrage de remplacement de votre système de stockage AFF A220. L"AFF A220 ne prend en charge que les procédures de récupération manuelles du support de démarrage.' 
---
