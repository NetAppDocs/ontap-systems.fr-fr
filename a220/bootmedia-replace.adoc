...
summary: Vous devez localiser le support de démarrage dans la manette et suivre les instructions pour le remplacer. Le système AFF A220 ne prend en charge que les procédures de récupération manuelles du support de démarrage. 
---
