...
---
= Exigences - AFF A20, AFF A30 et AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Et la suite
Après avoir examiné la configuration requise pour le support de démarrage, link:bootmedia-shutdown-bmr.html["arrêtez le contrôleur défectueux"].
