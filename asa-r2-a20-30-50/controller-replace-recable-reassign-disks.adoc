...
summary: Rendez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système de stockage ASA A20, ASA A30 ou ASA A50 puisse reprendre son fonctionnement normal. La procédure de restitution varie selon le type de chiffrement utilisé par votre système. 
---
...
[role="lead"]
Renvoyez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système de stockage ASA A20, ASA A30 ou ASA A50 puisse reprendre son fonctionnement normal.  La procédure de restitution varie en fonction du type de cryptage utilisé par votre système : aucun cryptage, cryptage Onboard Key Manager (OKM) ou cryptage External Key Manager (EKM).
