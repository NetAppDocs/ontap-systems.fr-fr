...
summary: 'Remplacez le châssis de votre système de stockage ASA A20, ASA A30 ou ASA A50 lorsqu"une panne matérielle l"exige.  Le processus de remplacement implique le retrait des contrôleurs, le retrait des lecteurs, l"installation du châssis de remplacement et la réinstallation des composants du châssis.' 
---
...
[role="lead"]
Remplacez le châssis de votre système de stockage ASA A20, ASA A30 ou ASA A50 lorsqu'une panne matérielle l'exige.  Le processus de remplacement implique le retrait des contrôleurs, le retrait des lecteurs, l'installation du châssis de remplacement et la réinstallation des composants du châssis.
