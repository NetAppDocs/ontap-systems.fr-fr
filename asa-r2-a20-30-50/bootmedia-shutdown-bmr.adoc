...
summary: Arrêtez le contrôleur défectueux de votre système de stockage ASA A20, ASA A30 ou ASA A50 pour éviter la perte de données et assurer la stabilité du système lors du remplacement du support de démarrage. 
---
= Arrêter le contrôleur pour remplacer le support de démarrage - ASA A20, ASA A30 et ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez le contrôleur défectueux de votre système de stockage ASA A20, ASA A30 ou ASA A50 pour éviter la perte de données et assurer la stabilité du système lors du remplacement du support de démarrage.
