...
summary: 'Vérifiez que la configuration HA du contrôleur est active et fonctionne correctement sur votre système de stockage ASA A20, ASA A30 ou ASA A50, et vérifiez que les adaptateurs du système répertorient tous les chemins d"accès aux disques.' 
---
