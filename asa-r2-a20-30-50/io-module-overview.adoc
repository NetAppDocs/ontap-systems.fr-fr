...
---
= Vue d'ensemble de l'ajout et du remplacement d'un module E/S - ASA A20, ASA A30 et ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Les systèmes ASA A20, ASA A30 et ASA A50 offrent une grande flexibilité d'extension ou de remplacement des modules d'E/S pour améliorer la connectivité et les performances du réseau. L'ajout ou le remplacement d'un module d'E/S est essentiel lors de la mise à niveau des capacités réseau ou de l'adressage d'un module défaillant.
