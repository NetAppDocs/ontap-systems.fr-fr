...
summary: Remplacez la batterie NV de votre système ASA A20, ASA A30 ou ASA A50 lorsque la batterie commence à se décharger ou tombe en panne, car elle est responsable de la conservation des données système critiques pendant les pannes de courant. 
---
...
[role="lead"]
Remplacez la batterie NV de votre système ASA A20, ASA A30 ou ASA A50 lorsque la batterie commence à se décharger ou tombe en panne, car elle est responsable de la conservation des données système critiques pendant les pannes de courant. Le processus de remplacement implique l'arrêt du contrôleur défectueux, le retrait du module de contrôleur, le remplacement de la batterie NV, la réinstallation du module de contrôleur et le renvoi de la pièce défectueuse à NetApp.
