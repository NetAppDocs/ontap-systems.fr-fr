...
summary: 'Remplacez la batterie NV de votre système de stockage ASA A20, ASA A30 ou ASA A50 lorsque la batterie commence à perdre sa charge ou tombe en panne, car elle est responsable de la préservation des données critiques du système pendant les pannes de courant.  Le processus de remplacement implique l"arrêt du contrôleur défectueux, le retrait du module de contrôleur, le remplacement de la batterie NV, la réinstallation du module de contrôleur et le renvoi de la pièce défectueuse à NetApp.' 
---
= Remplacer la batterie NV - ASA A20, ASA A30 et ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
