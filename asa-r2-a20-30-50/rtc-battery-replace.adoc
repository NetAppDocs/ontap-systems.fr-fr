...
summary: 'Remplacez la pile de l"horloge temps réel (RTC), communément appelée pile bouton, dans votre système ASA A20, ASA A30 ou ASA A50 pour vous assurer que les services et applications reposant sur une synchronisation précise de l"heure restent opérationnels.' 
---
...
[role="lead"]
Remplacez la pile de l'horloge temps réel (RTC), communément appelée pile bouton, dans votre système ASA A20, ASA A30 ou ASA A50 pour vous assurer que les services et applications reposant sur une synchronisation précise de l'heure restent opérationnels.
