...
summary: 'Restaurer la configuration NetApp Storage Encryption (si nécessaire), installer les licences du contrôleur de remplacement, vérifier que les interfaces logiques (LIF) indiquent leur port d"origine, effectuer un contrôle de l"état du cluster, enregistrer le numéro de série du contrôleur de remplacement, puis renvoyer la pièce défectueuse à NetApp pour terminer l"étape finale de la procédure de remplacement du contrôleur ASA A20, ASA A30 ou ASA A50.' 
---
...
[role="lead"]
Restaurer la configuration NetApp Storage Encryption (si nécessaire), installer les licences du contrôleur de remplacement, vérifier que les interfaces logiques (LIF) indiquent leur port d'origine, effectuer un contrôle de l'état du cluster, enregistrer le numéro de série du contrôleur de remplacement, puis renvoyer la pièce défectueuse à NetApp pour terminer l'étape finale de la procédure de remplacement du contrôleur ASA A20, ASA A30 ou ASA A50.
