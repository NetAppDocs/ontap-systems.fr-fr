...
summary: 'Pour terminer le remplacement du contrôleur de votre système de stockage ASA A20, ASA A30 ou ASA A50, commencez par restaurer la configuration NetApp Storage Encryption et installez les licences requises sur le nouveau contrôleur. Ensuite, vérifiez que les interfaces logiques sont rattachées à leurs ports d"attache et effectuez une vérification de l"état du cluster. Enfin, enregistrez le numéro de série du nouveau contrôleur, puis retournez la pièce défaillante à NetApp.' 
---
= Remplacement complet du contrôleur - ASA A20, ASA A30 et ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
