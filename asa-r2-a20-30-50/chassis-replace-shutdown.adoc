...
summary: Arrêtez les contrôleurs de votre système de stockage ASA A20, ASA A30 ou ASA A50 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du châssis 
---
= Arrêter les contrôleurs pour remplacer le châssis - ASA A20, ASA A30 et ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez les contrôleurs de votre système de stockage ASA A20, ASA A30 ou ASA A50 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du châssis.
