...
summary: 'Remplacer le contrôleur de votre système ASA A20, ASA A30 ou ASA A50 en cas de défaillance matérielle. Le processus de remplacement implique le retrait du contrôleur défectueux, le déplacement des composants vers le contrôleur de remplacement, l"installation du contrôleur de remplacement et son redémarrage.' 
---
= Remplacer le contrôleur - ASA A20, ASA A30 et ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacer le contrôleur de votre système ASA A20, ASA A30 ou ASA A50 en cas de défaillance matérielle. Le processus de remplacement implique le retrait du contrôleur défectueux, le déplacement des composants vers le contrôleur de remplacement, l'installation du contrôleur de remplacement et son redémarrage.
...
.Et la suite ?
Après avoir remplacé le contrôleur ASA A20, ASA A30 ou ASA A50 défectueux, vous devez link:controller-replace-system-config-restore-and-verify.html["restaurez la configuration du système"].
