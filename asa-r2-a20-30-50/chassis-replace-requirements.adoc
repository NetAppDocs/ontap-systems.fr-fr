...
summary: Avant de remplacer le châssis de votre système de stockage ASA A20, ASA A30 ou ASA A50, assurez-vous de répondre aux exigences nécessaires pour un remplacement réussi.  Cela comprend la vérification du bon fonctionnement de tous les autres composants du système, la vérification que vous disposez du châssis de remplacement approprié et des outils nécessaires. 
---
