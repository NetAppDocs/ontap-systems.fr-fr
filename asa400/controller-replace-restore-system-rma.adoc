...
summary: 'Terminez le remplacement du contrôleur de votre système ASA A400. Installez les licences du contrôleur de remplacement, vérifiez que les interfaces logiques (LIF) sont rattachées à leurs ports d"origine et effectuez une vérification de l"état du cluster. Enfin, retournez la pièce défectueuse à NetApp.' 
---
= Remplacement complet du contrôleur - ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Terminez le remplacement du contrôleur de votre système ASA A400. Installez les licences du contrôleur de remplacement, vérifiez que les interfaces logiques (LIF) sont rattachées à leurs ports d'origine et effectuez une vérification de l'état du cluster. Enfin, retournez la pièce défectueuse à NetApp.
