...
summary: Rendez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système ASA A400 puisse reprendre son fonctionnement normal. 
---
= Restituez le contrôleur - ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Rendez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système ASA A400 puisse reprendre son fonctionnement normal.
