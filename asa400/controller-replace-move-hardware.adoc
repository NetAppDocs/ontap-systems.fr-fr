...
summary: 'Remplacez le contrôleur de votre système ASA A400 lorsqu"une défaillance matérielle l"exige. Retirez le contrôleur défectueux, transférez ses composants vers le contrôleur de remplacement, installez le nouveau contrôleur et redémarrez-le.' 
---
...
[role="lead"]
Remplacez le contrôleur de votre système ASA A400 lorsqu'une défaillance matérielle l'exige. Retirez le contrôleur défectueux, transférez ses composants vers le contrôleur de remplacement, installez le nouveau contrôleur et redémarrez-le.
...
.Et la suite ?
Après avoir remplacé le contrôleur ASA A400 défectueux, vous devez link:controller-replace-system-config-restore-and-verify.html["restaurez la configuration du système"].
