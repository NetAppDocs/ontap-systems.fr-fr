...
summary: 'Vous remplacez la pile de l"horloge temps réel (RTC) dans le module de contrôle afin que les services et applications de votre système qui dépendent d"une synchronisation horaire précise continuent de fonctionner.' 
---
= Remplacez la pile de l'horloge temps réel - ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_c400_remove_controller_IEOPS-1216.svg[Déposer le module de contrôleur]
...
.Animation - remplacez la batterie RTC
video::12ea4bc1-75e2-43e7-be91-b0310000fd34[panopto]
image::../media/drw_c400_rtc_batt_IEOPS-1239.svg[Déposer la batterie RTC]
