...
summary: 'Remplacez la batterie non volatile de votre système AFF A70 ou AFF A90 lorsque la batterie commence à se décharger ou tombe en panne, car elle est chargée de préserver les données système critiques pendant les pannes de courant. Le processus de remplacement implique l"arrêt du contrôleur défectueux, le retrait du module de contrôleur, le remplacement de la batterie NV, la réinstallation du module de contrôleur et le renvoi de la pièce défectueuse à NetApp.' 
---
= Remplacez la batterie NV - AFF A70 et AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la batterie non volatile de votre système AFF A70 ou AFF A90 lorsque la batterie commence à se décharger ou tombe en panne, car elle est chargée de préserver les données système critiques pendant les pannes de courant. Le processus de remplacement implique l'arrêt du contrôleur défectueux, le retrait du module de contrôleur, le remplacement de la batterie NV, la réinstallation du module de contrôleur et le renvoi de la pièce défectueuse à NetApp.
