...
summary: 'Remplacez un module DIMM dans votre système AFF A70 ou AFF A90 en cas d"erreurs trop corrigibles ou non corrigibles détectées. Ces problèmes, souvent provoqués par une panne de module DIMM unique, peuvent empêcher le système de stockage de démarrer ONTAP.' 
---
...
[role="lead"]
Remplacez un module DIMM dans votre système AFF A70 ou AFF A90 en cas d'erreurs trop corrigibles ou non corrigibles détectées. Ces problèmes, souvent provoqués par une panne de module DIMM unique, peuvent empêcher le système de stockage de démarrer ONTAP.
