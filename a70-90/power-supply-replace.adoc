...
summary: 'Remplacez le bloc d"alimentation CA ou CC de votre AFF A70 ou AFF A90 lorsqu"il tombe en panne ou présente un dysfonctionnement, afin de garantir que votre système continue de recevoir l"alimentation requise pour un fonctionnement stable. Le processus de remplacement consiste à déconnecter le bloc d"alimentation défectueux de la source d"alimentation, à débrancher le câble d"alimentation, à remplacer le bloc d"alimentation défectueux, puis à le reconnecter à la source d"alimentation.' 
---
= Remplacement à chaud d'une alimentation - AFF A70 et AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
