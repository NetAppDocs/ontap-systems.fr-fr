...
---
= Procédure de remplacement des supports de démarrage - AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Avant de commencer
Pour remplacer le support de démarrage, votre doit répondre à certaines exigences. Examinez le link:bootmedia-replace-requirements.html["configuration requise et considérations relatives aux supports de démarrage"].
