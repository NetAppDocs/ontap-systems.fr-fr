...
[role="lead"]
Commencez par remplacer le support de démarrage de votre système de stockage AFF A70 ou AFF A90 en préparant le support de remplacement, en l'installant dans le système, en restaurant l'image de démarrage et en vérifiant le fonctionnement du système.
