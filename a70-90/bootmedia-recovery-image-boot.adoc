...
summary: 'Après avoir installé le nouveau périphérique de démarrage sur votre système AFF A70 ou AFF A90, vous pouvez démarrer l"image de récupération à partir d"un lecteur USB et restaurer la configuration à partir du nœud partenaire.' 
---
= Démarrez l'image de récupération - AFF A70 et AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir installé le nouveau périphérique de démarrage sur votre système AFF A70 ou AFF A90, vous pouvez démarrer l'image de récupération à partir d'un lecteur USB et restaurer la configuration à partir du nœud partenaire.
