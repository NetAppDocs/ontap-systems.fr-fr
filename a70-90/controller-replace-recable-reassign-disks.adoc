...
summary: Rrenvoyez le contrôle des ressources de stockage vers le contrôleur de remplacement afin que votre système AFF A70 ou AFF A90 puisse reprendre un fonctionnement normal. 
---
