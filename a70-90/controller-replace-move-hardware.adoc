...
summary: 'Remplacez le contrôleur de votre système AFF A70 ou AFF A90 en cas de panne matérielle ou de mise à niveau. Ce processus implique de retirer le contrôleur défectueux, de déplacer les composants vers le contrôleur de remplacement, d"installer le contrôleur de remplacement et de le redémarrer.' 
---
...
[role="lead"]
Remplacez le contrôleur de votre système AFF A70 ou AFF A90 en cas de panne matérielle ou de mise à niveau. Ce processus implique de retirer le contrôleur défectueux, de déplacer les composants vers le contrôleur de remplacement, d'installer le contrôleur de remplacement et de le redémarrer.
