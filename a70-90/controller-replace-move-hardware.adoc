...
.Et la suite ?
Après avoir remplacé le contrôleur AFF A70 ou AFF A90 défectueux, vous devez :link:controller-replace-system-config-restore-and-verify.html["restaurez la configuration du système"] .
