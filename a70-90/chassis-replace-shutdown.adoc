...
summary: Arrêtez les contrôleurs de votre système de stockage AFF A70 ou AFF A90 pour éviter la perte de données et assurer la stabilité du système lors du remplacement du châssis. 
---
= Arrêtez les contrôleurs pour remplacer le châssis - AFF A70 et AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez les contrôleurs de votre système de stockage AFF A70 ou AFF A90 pour éviter la perte de données et assurer la stabilité du système lors du remplacement du châssis.
...
.Et la suite ?
Après avoir éteint les contrôleurs,link:chassis-replace-move-hardware.html["remplacez le châssis"] .
