...
summary: 'Arrêtez les contrôleurs de votre système de stockage AFF A70 ou AFF A90 lorsque vous devez remplacer le châssis. Avant toute opération de maintenance ou de remplacement de composants, il est essentiel d"arrêter le contrôleur en toute sécurité afin d"éviter toute perte de données et de garantir la stabilité du système.' 
---
