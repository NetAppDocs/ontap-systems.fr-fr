...
summary: 'Arrêtez les contrôleurs de votre système de stockage AFF A70 ou AFF A90 lorsque vous devez remplacer le châssis. Il est essentiel d"arrêter le contrôleur en toute sécurité pour éviter toute perte de données et assurer la stabilité du système.' 
---
...
[role="lead"]
Arrêtez les contrôleurs de votre système de stockage AFF A70 ou AFF A90 lorsque vous devez remplacer le châssis. Il est essentiel d'arrêter les contrôleurs en toute sécurité pour éviter toute perte de données et assurer la stabilité du système.
