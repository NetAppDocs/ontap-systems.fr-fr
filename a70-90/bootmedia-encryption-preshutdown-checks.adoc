...
summary: 'Pour assurer la sécurité des données de votre système de stockage AFF A70 et AFF A90, vous devez vérifier la prise en charge et l"état de la clé de chiffrement. Vérifiez si votre version de ONTAP prend en charge NetApp Volume Encryption (NVE) et avant d"arrêter le contrôleur, vérifiez si le gestionnaire de clés est actif.' 
---
= Vérifiez la prise en charge et l'état de la clé de cryptage - AFF A70 et AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Pour assurer la sécurité des données de votre système de stockage AFF A70 et AFF A90, vous devez vérifier la prise en charge et l'état de la clé de chiffrement. Vérifiez si votre version de ONTAP prend en charge NetApp Volume Encryption (NVE) et avant d'arrêter le contrôleur, vérifiez si le gestionnaire de clés est actif.
