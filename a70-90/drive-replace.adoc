...
summary: 'Remplacez un disque de votre système AFF A70 ou AFF A90 en cas de panne ou de mise à niveau requise. Ce processus implique d"identifier le lecteur défectueux, de le retirer en toute sécurité et d"installer un nouveau lecteur pour garantir un accès continu aux données et des performances du système.' 
---
= Remplacez le lecteur SSD - AFF A70 et AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez un disque de votre système AFF A70 ou AFF A90 en cas de panne ou de mise à niveau requise. Ce processus implique d'identifier le lecteur défectueux, de le retirer en toute sécurité et d'installer un nouveau lecteur pour garantir un accès continu aux données et des performances du système.
