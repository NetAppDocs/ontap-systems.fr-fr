...
[role="lead"]
Vérifiez que les interfaces logiques dépendent de leur port de home, effectuez une vérification de l'état du cluster, puis renvoyez la pièce défectueuse à NetApp pour terminer l'étape finale de la procédure de remplacement du contrôleur AFF A70 and AFF A90.
