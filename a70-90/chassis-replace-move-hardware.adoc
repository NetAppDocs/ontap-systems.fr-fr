...
summary: 'Remplacez le châssis de votre système AFF A70 ou AFF A90 lorsqu"une défaillance matérielle l"exige. La procédure de remplacement consiste à retirer les contrôleurs et les blocs d"alimentation, à retirer les disques, à installer le châssis de remplacement, puis à réinstaller les composants du châssis.' 
---
