...
summary: Après avoir activé votre système de stockage AFF A70 ou AFF A90, vous êtes prêt à détecter votre réseau en cluster et à configurer un cluster ONTAP. 
---
= Installation et configuration complètes du système de stockage - AFF A70 et AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir activé votre système de stockage AFF A70 ou AFF A90, vous êtes prêt à détecter votre réseau en cluster et à configurer un cluster ONTAP.
