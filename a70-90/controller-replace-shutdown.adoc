...
summary: Arrêtez le contrôleur de votre système de stockage AFF A70 ou AFF A90 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du contrôleur. 
---
= Arrêtez le contrôleur défectueux - AFF A70 et AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez le contrôleur de votre système de stockage AFF A70 ou AFF A90 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du contrôleur.
