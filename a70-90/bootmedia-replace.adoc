...
---
= Remplacez le support de démarrage - AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Pour remplacer le support de démarrage, vous devez retirer le module de gestion du système de l'arrière du système, retirer le support de démarrage défectueux, installer le support de démarrage de remplacement dans le module de gestion du système et transférer l'image de démarrage sur une clé USB.
