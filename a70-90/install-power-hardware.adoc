...
---
= Mettez le système de stockage sous tension : AFF A70 et AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Une fois que vous avez installé le matériel rack du système de stockage AFF A70 ou AFF A90 et que vous avez installé les câbles des contrôleurs et des tiroirs de stockage, vous devez mettre vos tiroirs et contrôleurs de stockage sous tension.
...
* Remarque : pour être valides, les ID de tiroir externe doivent être compris entre 01 et 99.
+
...
.. Appuyez sur le bouton d'ID du tiroir et relâchez-le pour avancer le chiffre jusqu'à atteindre le chiffre souhaité de 0 à 9, ou de 1 à 9 si le système est équipé d'un système de stockage intégré.
+
...
.Et la suite ?
Après avoir allumé votre système de stockage AFF A70 ou AFF A90, vous link:install-complete.html["terminez l'installation et la configuration du système"].
