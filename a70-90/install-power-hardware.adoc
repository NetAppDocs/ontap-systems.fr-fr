...
summary: Une fois que vous avez installé le matériel rack du système de stockage AFF A70 ou AFF A90 et que vous avez installé les câbles des contrôleurs et des tiroirs de stockage, vous devez mettre vos tiroirs et contrôleurs de stockage sous tension. 
---
...
.Et la suite ?
Après avoir allumé votre système de stockage AFF A70 ou AFF A90 , vous https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["configurer votre cluster"] .
