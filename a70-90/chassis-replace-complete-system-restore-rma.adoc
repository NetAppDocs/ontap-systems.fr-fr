...
[role="lead"]
Pour terminer le processus de remplacement du châssis, vous devez démarrer sur ONTAP, restituer le stockage, vérifier l'état de santé du système de stockage et renvoyer le châssis défectueux à NetApp.
