...
summary: Vous devez remplacer le module de cache du contrôleur lorsque votre système enregistre un seul message AutoSupport indiquant que le module est hors ligne. À défaut, les performances seront dégradées. 
---
...
+
image::../media/drw_rxl_fcache.png[Retrait ou remplacement du module de cache]
