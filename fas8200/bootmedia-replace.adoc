...
summary: 'Remplacez le support de démarrage défectueux sur un module contrôleur FAS8200 . Le système FAS8200 ne prend en charge que les procédures de récupération manuelle du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
...
[role="lead"]
Remplacez le support de démarrage défectueux sur un module contrôleur FAS8200 . Cette procédure comprend le retrait du module contrôleur du châssis, le remplacement physique du composant de support de démarrage, le transfert de l'image de démarrage sur le support de remplacement à l'aide d'une clé USB et la restauration du système à son fonctionnement normal.
