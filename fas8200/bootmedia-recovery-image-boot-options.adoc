...
summary: 'Démarrez l"image de récupération ONTAP depuis la clé USB sur un système FAS8200 pour restaurer le support de démarrage. Le système FAS8200 ne prend en charge que les procédures de récupération manuelle du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
= Démarrez l'image de restauration - FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Démarrez l'image de récupération ONTAP à partir de la clé USB sur un système FAS8200 pour restaurer le support de démarrage. Cette procédure comprend le démarrage à partir de la clé USB, la restauration du système de fichiers, la vérification des variables d'environnement et le retour du contrôleur à un fonctionnement normal, avec des étapes spécifiques qui varient selon que le système est configuré en MetroCluster à deux nœuds.
