...
summary: 'Découvrez comment remplacer le support de démarrage sur un système FAS8200 et comprenez les différentes méthodes de remplacement. Le système FAS8200 ne prend en charge que les procédures de récupération manuelle du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
