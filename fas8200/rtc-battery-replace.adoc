...
---
= Remplacez la pile de l'horloge en temps réel - FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Pour remplacer la batterie RTC, localisez-les à l'intérieur du contrôleur et suivez la séquence d'étapes spécifique.

. Si vous n'êtes pas déjà mis à la terre, mettez-vous à la terre correctement.
. Localisez la batterie RTC.
+
image::../media/drw_rxl_rtc_battery.png[Retirez et remplacez la batterie RTC]
