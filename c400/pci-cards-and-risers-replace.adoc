...
---
= Remplacez une carte PCIe ou mezzanine - AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Serrez complètement les vis moletées de la carte mezzanine. Si elles sont desserrées, les ports e0e à e0h peuvent ne pas être détectés, la LED peut clignoter en continu et les journaux peuvent afficher une erreur "unsupported cable".
