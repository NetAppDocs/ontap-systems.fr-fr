...
---
= Récupération automatique du support de démarrage à partir du nœud partenaire - AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir installé le nouveau support de démarrage sur votre système AFF C400 , vous pouvez lancer la récupération automatique du support de démarrage pour restaurer la configuration depuis le nœud partenaire.
