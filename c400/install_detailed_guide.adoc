...
+
image::../media/drw_c400_TNSC-network-cabling.png[Câblage réseau drw c400 TNSC]
...
+
image::../media/drw_c400_switched_network_cabling.png[câblage réseau commuté drw c400]
...
+
image::../media/drw_c400_one_ns224_shelves.png[drw c400 une étagère ns224]
...
+
image::../media/drw_c400_two_ns224_shelves.png[drw c400 deux étagères ns224]
