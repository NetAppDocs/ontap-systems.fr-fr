...
summary: Rendez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système AFF C400 puisse reprendre son fonctionnement normal. 
---
= Rendez le contrôleur - AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Rendez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système AFF C400 puisse reprendre son fonctionnement normal.
