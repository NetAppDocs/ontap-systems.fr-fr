...
summary: 'Vous devez remplacer une barrette DIMM dans le module contrôleur lorsque votre système enregistre un nombre croissant de codes de correction d"erreurs corrigibles (ECC), faute de quoi le système paniquera.' 
---
= Remplacez un module DIMM - AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
