...
summary: 'Finalisez le remplacement du contrôleur de votre AFF C400. Installez les licences du contrôleur de remplacement, vérifiez que les interfaces logiques (LIF) sont bien rattachées à leurs ports d"origine et effectuez une vérification de l"état du cluster. Enfin, retournez la pièce défectueuse à NetApp.' 
---
= Remplacement complet du contrôleur - AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Finalisez le remplacement du contrôleur de votre AFF C400. Installez les licences du contrôleur de remplacement, vérifiez que les interfaces logiques (LIF) sont bien rattachées à leurs ports d'origine et effectuez une vérification de l'état du cluster. Enfin, retournez la pièce défectueuse à NetApp.
