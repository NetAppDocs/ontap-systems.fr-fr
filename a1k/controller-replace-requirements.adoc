...
---
= Exigences de remplacement du contrôleur - AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vérifiez la configuration requise pour la procédure de remplacement du contrôleur et sélectionnez celle qui convient à votre version du système d'exploitation ONTAP.
