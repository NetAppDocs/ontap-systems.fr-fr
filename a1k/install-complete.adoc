...
summary: 'Effectuez l"installation et la configuration à l"aide de la détection de cluster uniquement via une connexion au commutateur et à l"ordinateur portable, ou en vous connectant directement à un contrôleur du système de stockage, puis au commutateur de gestion.' 
---
...
[role="lead"]
Après avoir activé votre système de stockage AFF A1K, vous êtes prêt à détecter votre réseau en cluster et à configurer un cluster ONTAP.
