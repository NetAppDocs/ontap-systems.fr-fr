...
summary: 'Remplacez la pile de l"horloge temps réel, communément appelée pile bouton, dans votre système AFF A1K pour garantir que les services et applications nécessitant une synchronisation horaire précise restent opérationnels.' 
---
= Remplacez la pile de l'horloge temps réel - AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la pile de l'horloge en temps réel (RTC), communément appelée pile bouton, dans votre système AFF A1K pour vous assurer que les services et applications reposant sur une synchronisation précise de l'heure restent opérationnels.
