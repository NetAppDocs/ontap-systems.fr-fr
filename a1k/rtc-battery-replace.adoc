...
summary: 'Remplacez la pile de l"horloge en temps réel (RTC), communément appelée pile bouton, dans votre système AFF A1K pour vous assurer que les services et applications reposant sur une synchronisation précise de l"heure restent opérationnels.' 
---
