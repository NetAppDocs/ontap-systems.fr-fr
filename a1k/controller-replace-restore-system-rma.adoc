...
summary: 'Pour terminer le remplacement du contrôleur de votre système AFF A1K, restaurez la configuration de chiffrement du stockage NetApp, vérifiez que les interfaces logiques communiquent avec leurs ports d"attache, effectuez une vérification de l"état du cluster et retournez la pièce défectueuse à NetApp.' 
---
