...
summary: 'Arrêtez le contrôleur de votre système de stockage AFF A1K lorsqu"il est défectueux. Avant toute opération de maintenance ou de remplacement de composants, il est essentiel d"arrêter le contrôleur en toute sécurité afin d"éviter toute perte de données et de garantir la stabilité du système.' 
---
...
[role="lead"]
Arrêtez le contrôleur de votre système de stockage AFF A1K lorsqu'il est défectueux. Avant toute opération de maintenance ou de remplacement de composants, il est essentiel d'arrêter le contrôleur en toute sécurité afin d'éviter toute perte de données et de garantir la stabilité du système.
