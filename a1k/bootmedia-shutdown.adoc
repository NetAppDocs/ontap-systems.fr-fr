...
summary: 'Arrêtez le contrôleur de votre système de stockage AFF A1K lorsque vous devez remplacer le support de démarrage. Avant toute opération de maintenance ou de remplacement de composants, il est essentiel d"arrêter le contrôleur en toute sécurité afin d"éviter toute perte de données et de garantir la stabilité du système.' 
---
