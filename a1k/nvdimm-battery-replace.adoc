...
summary: 'Remplacez la batterie NV de votre système AFF A1K lorsque la batterie commence à perdre ou à se décharger, car elle est chargée de préserver les données système critiques pendant les pannes de courant. Le processus de remplacement implique l"arrêt du contrôleur défectueux, le retrait du module de contrôleur, le remplacement de la batterie NV, la réinstallation du module de contrôleur et le renvoi de la pièce défectueuse à NetApp.' 
---
...
[role="lead"]
Remplacez la batterie NV de votre système AFF A1K lorsque la batterie commence à perdre ou à se décharger, car elle est chargée de préserver les données système critiques pendant les pannes de courant. Le processus de remplacement implique l'arrêt du contrôleur défectueux, le retrait du module de contrôleur, le remplacement de la batterie NV, la réinstallation du module de contrôleur et le renvoi de la pièce défectueuse à NetApp.
