...
[role="lead"]
Après avoir installé le nouveau périphérique de démarrage sur votre système AFF A1K, vous pouvez démarrer l'image de récupération à partir d'un lecteur USB et restaurer la configuration à partir du nœud partenaire.
