...
[role="lead"]
Vous devrez peut-être effectuer des procédures de maintenance sur votre matériel. Cette section présente les procédures spécifiques à la maintenance des composants du système AFF A1K.

Les procédures décrites dans cette section supposent que le système AFF A1K a déjà été déployé en tant que nœud de stockage dans l'environnement ONTAP.
