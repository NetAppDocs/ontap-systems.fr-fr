...
link:chassis-replace-workflow.html["Châssis"]
 a| 
Le châssis abrite les ventilateurs, le contrôleur, les blocs d'alimentation et les blocs d'alimentation, la NVRAM12, le module de gestion du système, les cartes d'E/S et les modules de masquage.
