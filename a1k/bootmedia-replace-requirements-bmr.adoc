...
summary: Avant de remplacer le support de démarrage de votre système AFF A1K , assurez-vous de répondre aux exigences nécessaires pour un remplacement réussi. 
---
= Conditions requises pour la récupération automatique du support de démarrage - AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
