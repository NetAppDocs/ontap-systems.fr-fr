...
.Et la suite ?
Après avoir allumé votre système de stockage AFF A1K , vous https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["configurer votre cluster"] .
