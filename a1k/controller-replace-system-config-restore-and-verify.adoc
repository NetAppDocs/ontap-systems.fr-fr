...
summary: 'Vérifiez que la configuration haute disponibilité du contrôleur est active et qu"elle fonctionne correctement dans votre système de stockage AFF A1K, puis vérifiez que les adaptateurs du système répertorient tous les chemins d"accès aux disques.' 
---
...
[role="lead"]
Vérifiez que la configuration haute disponibilité du contrôleur est active et qu'elle fonctionne correctement dans votre système de stockage AFF A1K, puis vérifiez que les adaptateurs du système répertorient tous les chemins d'accès aux disques.
...
.Et la suite ?
Après avoir restauré et vérifié la configuration système de votre système AFF A1K, vous devez link:controller-replace-recable-reassign-disks.html["remettez le contrôleur en place"].
