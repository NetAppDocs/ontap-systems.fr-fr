...
summary: 'Vous pouvez remplacer un module d"étagère NVMe (NSM) endommagé sans interruption dans une étagère de lecteur NX224 sous tension et pendant que les E/S sont en cours.' 
---
= Remplacer un NSM dans un shelf NX224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Avant de refermer le couvercle NSM endommagé, assurez-vous que les languettes d'éjection de tous les emplacements DIMM vides sont complètement remises en position verrouillée.
