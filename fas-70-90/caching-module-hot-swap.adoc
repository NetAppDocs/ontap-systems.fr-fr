...
summary: 'Le support de module Flash cache SSD NVMe contient un ou deux modules Flash cache (modules de cache) avec un seul disque de cache SSD intégré dans chaque module de cache. Les modules de cache peuvent être échangés à chaud, mais le support de module Flash cache n"est pas échangeable à chaud.' 
---
...
[role="lead"]
Le support de module Flash cache SSD NVMe contient un ou deux modules Flash cache (modules de cache) avec un seul disque Flash cache SSD intégré dans chaque module de cache.
...
Selon ce qui doit être remplacé, vous pouvez effectuer l'une des procédures suivantes : support de module Flash cache complet ou module de cache.
