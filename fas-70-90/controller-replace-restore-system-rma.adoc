...
summary: 'Vérifiez que les interfaces logiques LIF sont bien connectées à leur port d"attache, effectuez une vérification de l"état, puis renvoyez la pièce défaillante à NetApp pour terminer la dernière étape de la procédure de remplacement du contrôleur FAS70 ou FAS90.' 
---
