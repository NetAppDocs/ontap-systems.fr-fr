...
summary: Remplacez le NVRAM de votre système FAS70 ou FAS90 lorsque la mémoire non volatile est défectueuse ou nécessite une mise à niveau. 
---
= Remplacer NVRAM - FAS70 et FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le NVRAM de votre système FAS70 ou FAS90 lorsque la mémoire non volatile est défectueuse ou nécessite une mise à niveau. Le processus de remplacement implique l'arrêt du contrôleur défectueux, le remplacement du module NVRAM ou du module DIMM NVRAM, la réaffectation des disques et le renvoi de la pièce défectueuse à NetApp.
...
Après avoir remplacé le FRU, vous devez redémarrer le module de contrôleur en rebranchant les câbles d'alimentation sur le bloc d'alimentation.
