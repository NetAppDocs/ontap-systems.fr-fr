...
summary: données de configuration. Si le support de démarrage échoue, vous devez débrancher le module de contrôleur, retirer le module de gestion du système, retirer le support de démarrage défectueux et installer le support de démarrage de remplacement dans le module de gestion du système. 
---
