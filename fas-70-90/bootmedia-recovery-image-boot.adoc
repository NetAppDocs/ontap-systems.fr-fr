...
[role="lead"]
Après avoir installé le nouveau périphérique de démarrage sur votre système FAS70 ou FAS90, vous pouvez démarrer l'image de restauration à partir d'un lecteur USB et restaurer la configuration à partir du nœud partenaire.
