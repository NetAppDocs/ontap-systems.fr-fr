...
summary: 'Remplacez un module de ventilation de votre système FAS70 ou FAS90 en cas de panne d"un ventilateur ou de dysfonctionnement, car cela peut affecter le refroidissement du système et les performances globales. Le processus de remplacement implique l"arrêt du contrôleur, le retrait du contrôleur, le remplacement du ventilateur, la réinstallation du contrôleur et le renvoi de la pièce défectueuse à NetApp.' 
---
...
[role="lead"]
Remplacez un module de ventilation de votre système FAS70 ou FAS90 en cas de panne d'un ventilateur ou de dysfonctionnement, car cela peut affecter le refroidissement du système et les performances globales. Le processus de remplacement implique l'arrêt du contrôleur, le retrait du contrôleur, le remplacement du ventilateur, la réinstallation du contrôleur et le renvoi de la pièce défectueuse à NetApp.
