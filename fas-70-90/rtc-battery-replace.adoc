...
summary: 'Remplacez la pile de l"horloge temps réel (RTC), communément appelée pile bouton, de votre système FAS70 ou FAS90 pour garantir que les services et applications reposant sur une synchronisation horaire précise restent opérationnels.' 
---
