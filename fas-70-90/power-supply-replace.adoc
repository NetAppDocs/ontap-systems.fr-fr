...
summary: 'Remplacez une unité d"alimentation électrique (PSU) CA ou CC dans votre système FAS70 ou FAS90 lorsqu"elle tombe en panne ou devient défectueuse, afin de garantir que votre système continue de recevoir l"alimentation requise pour un fonctionnement stable. Le processus de remplacement consiste à déconnecter l"unité d"alimentation défectueuse de la source d"alimentation, à débrancher le câble d"alimentation, à remplacer l"unité d"alimentation défectueuse, puis à la reconnecter à la source d"alimentation.' 
---
= Remplacement à chaud d'une alimentation - FAS70 et FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez un bloc d'alimentation CA ou CC de votre système FAS70 ou FAS90 en cas de panne ou de panne, en veillant à ce que votre système continue de recevoir l'alimentation requise pour un fonctionnement stable. Le processus de remplacement consiste à déconnecter le bloc d'alimentation défectueux de la source d'alimentation, à débrancher le câble d'alimentation, à remplacer le bloc d'alimentation défectueux, puis à le rebrancher à la source d'alimentation.
...
Cette procédure est rédigée pour remplacer une seule alimentation à la fois. Utilisez la procédure appropriée pour votre type d'alimentation : AC ou DC.
