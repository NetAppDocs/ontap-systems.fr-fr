...
summary: 'Arrêter le contrôleur de votre système de stockage FAS70 ou FAS90 lorsque vous devez remplacer le support de démarrage. Avant toute opération de maintenance ou de remplacement de composants, il est essentiel d"arrêter le contrôleur en toute sécurité afin d"éviter toute perte de données et de garantir la stabilité du système.' 
---
...
[role="lead"]
Arrêter le contrôleur de votre système de stockage FAS70 ou FAS90 lorsque vous devez remplacer le support de démarrage. Avant toute opération de maintenance ou de remplacement de composants, il est essentiel d'arrêter le contrôleur en toute sécurité afin d'éviter toute perte de données et de garantir la stabilité du système.
