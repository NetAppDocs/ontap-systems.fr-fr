...
summary: Vous devez remplacer le module de cache du contrôleur dès que votre système enregistre un seul AutoSupport ASUP message indiquant que le module est hors ligne. À défaut, les performances seront dégradées. 
---
