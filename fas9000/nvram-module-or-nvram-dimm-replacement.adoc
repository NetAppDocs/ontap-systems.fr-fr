...
summary: 'Le module NVRAM se compose du NVRAM10, des DIMM et jusqu"à deux modules de cache Flash SSD NVMe, Flash Cache ou modules de mise en cache, par module NVRAM.' 
---
