...
summary: 'La procédure de démarrage du nœud défectueux à partir de l"image de récupération dépend de la configuration du système (MetroCluster à deux nœuds ou non). Le système FAS9000 ne prend en charge que les procédures de récupération manuelle du support de démarrage.' 
---
