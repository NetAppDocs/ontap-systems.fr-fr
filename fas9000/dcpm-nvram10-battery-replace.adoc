...
summary: 'Pour remplacer à chaud un module d"alimentation DCPM de contrôleur de désétage, qui contient la batterie NVRAM10, vous devez localiser le module DCPM défectueux, le retirer du châssis et installer le module DCPM de remplacement.' 
---
