...
summary: Pour terminer la procédure de remplacement et rétablir le fonctionnement optimal de votre système, vous devez recâbler le stockage, restaurer la configuration de chiffrement du stockage NetApp si nécessaire et installer les licences pour le nouveau contrôleur. 
---
= Restauration complète du système - FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Étape 3 : (MetroCluster uniquement) : basculement d'agrégats dans une configuration MetroCluster à deux nœuds
