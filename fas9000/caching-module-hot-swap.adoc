...
summary: 'Les modules Flash cache SSD NVMe (Flash cache ou modules de cache) sont situés à l"avant du module NVRAM10 dans le slot 6 des systèmes FAS9000 uniquement. Depuis ONTAP 9.4, vous pouvez remplacer à chaud le module de cache de même capacité par un fournisseur identique ou différent.' 
---
...
[role="lead"]
Les modules Flash cache SSD NVMe (Flash cache ou modules de cache) sont situés à l'avant du module NVRAM10 dans le slot 6 des systèmes FAS9000 uniquement. Depuis ONTAP 9.4, vous pouvez remplacer à chaud le module de cache de même capacité par un fournisseur identique ou différent.
