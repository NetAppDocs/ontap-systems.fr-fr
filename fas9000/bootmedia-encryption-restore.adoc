...
summary: 'Une fois les variables d"environnement vérifiées, vous devez effectuer les étapes spécifiques aux systèmes disposant de Onboard Key Manager OKM, NetApp Storage Encryption NSE ou NetApp Volume Encryption NVE activés. Le système FAS9000 prend uniquement en charge les procédures de récupération manuelles à partir du support de démarrage.' 
---
