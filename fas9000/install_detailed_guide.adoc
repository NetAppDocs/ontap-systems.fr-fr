...
---
= Guide détaillé - AFF A700 et FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
https://["Installez les tiroirs et reliez-les à une nouvelle installation du système, à savoir les tiroirs dotés de modules IOM12"]
