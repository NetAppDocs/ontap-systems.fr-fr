...
+
link:..https://docs.netapp.com/us-en/ontap-systems/sas3/install-new-system.html["Installez les tiroirs et reliez-les à une nouvelle installation du système, à savoir les tiroirs dotés de modules IOM12"]
