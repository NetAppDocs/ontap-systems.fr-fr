...
summary: 'Pour accéder aux composants à l"intérieur du contrôleur, vous devez d"abord retirer le module de contrôleur du système, puis retirer le couvercle du module de contrôleur. Le système FAS9000 ne prend en charge que les procédures de récupération manuelle du support de démarrage.' 
---
