...
---
= Exigences pour le remplacement du contrôleur - ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Avant de remplacer le contrôleur de votre système de stockage ASA A250, assurez-vous de respecter les conditions requises pour un remplacement réussi. Cela inclut de vérifier que tous les autres composants du système fonctionnent correctement, de vous assurer que vous disposez du contrôleur de remplacement adéquat et d'enregistrer la sortie de la console du contrôleur dans un fichier journal texte.
