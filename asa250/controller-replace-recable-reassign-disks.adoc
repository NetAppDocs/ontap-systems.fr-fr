...
---
= Recâblage du système et réaffectation des disques - ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir terminé la restauration et vérifié la configuration du système ASA A250, vous devez recâbler le système et réaffecter les disques.
