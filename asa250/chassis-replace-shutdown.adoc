...
---
= Arrêter les contrôleurs - ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Éteignez les contrôleurs de votre système de stockage ASA A250 pour éviter toute perte de données et garantir la stabilité du système lors du remplacement du châssis.
