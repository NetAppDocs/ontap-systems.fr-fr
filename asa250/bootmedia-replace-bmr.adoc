...
summary: Le support de démarrage de votre système ASA A250 contient le micrologiciel et les données de configuration essentiels. La procédure de remplacement consiste à retirer le module contrôleur, à retirer le support de démarrage défectueux, à installer le nouveau support de démarrage dans le module contrôleur, puis à réinstaller le module contrôleur. 
---
= Remplacez le support de démarrage pour la récupération de démarrage automatisée - ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
