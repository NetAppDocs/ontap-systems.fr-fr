...
summary: 'Pour remplacer le support de démarrage, vous devez retirer le module de contrôleur endommagé, installer le support de démarrage de remplacement et transférer l"image de démarrage sur une clé USB.' 
---
= Remplacez le support de démarrage et préparez-vous à la récupération manuelle du démarrage - ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
