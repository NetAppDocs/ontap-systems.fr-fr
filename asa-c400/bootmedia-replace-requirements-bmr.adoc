...
summary: 'Avant de remplacer le support de démarrage de votre ASA C400, assurez-vous de respecter les conditions requises pour une opération réussie. Cela inclut la vérification que vous disposez du support de démarrage de remplacement adéquat, la confirmation que le port e0S ou e0M du contrôleur défectueux n"est pas endommagé, et la détermination de l"activation du Onboard Key Manager ou de l"External Key Manager.' 
---
= Conditions requises pour la récupération automatique du support de démarrage - ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
