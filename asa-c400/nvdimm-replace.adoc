...
summary: 'Vous devez remplacer la barrette NVDIMM du module contrôleur lorsque votre système détecte que la durée de vie de la mémoire flash est presque terminée ou que la barrette NVDIMM identifiée n"est généralement pas saine. Si vous ne le faites pas, cela provoquera une panique du système.' 
---
= Remplacez un module NVDIMM - ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/drw_A400_Replace-NVDIMM-DIMM_IEOPS-1009.svg[Remplacez le NVDIMM]
