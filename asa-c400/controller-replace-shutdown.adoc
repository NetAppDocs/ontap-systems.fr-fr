...
summary: Éteignez le contrôleur de votre système de stockage ASA C400 pour éviter toute perte de données et garantir la stabilité du système lors du remplacement du contrôleur. 
---
= Arrêtez le contrôleur défectueux - ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Éteignez le contrôleur de votre système de stockage ASA C400 pour éviter toute perte de données et garantir la stabilité du système lors du remplacement du contrôleur.
...
====
.Et la suite ?
Après avoir arrêté le contrôleur ASA C400, vous devez link:controller-replace-move-hardware.html["remplacer le contrôleur"].
