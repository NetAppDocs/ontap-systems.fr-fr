...
summary: Rendez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système ASA C400 puisse reprendre son fonctionnement normal. 
---
= Rendre le contrôleur - ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Rendez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système ASA C400 puisse reprendre son fonctionnement normal.
