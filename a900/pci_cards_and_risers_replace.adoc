...
--
== étape 2 : remplacez les modules d'E/S.
...
== étape 3 : redémarrez le contrôleur après le remplacement du module d'E/S.
...
== étape 4 : renvoyez la pièce défectueuse à NetApp
