...
summary: Pour remettre votre système AFF A900 en parfait état de fonctionnement, recâblez le stockage, restaurez la configuration de chiffrement du stockage NetApp si nécessaire et installez les licences pour le nouveau contrôleur. 
---
= Restauration complète du système - AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Pour terminer la procédure de remplacement et restaurer le fonctionnement complet de votre système, restaurez la configuration du chiffrement de stockage NetApp (si nécessaire) et installez les licences pour le nouveau contrôleur.
