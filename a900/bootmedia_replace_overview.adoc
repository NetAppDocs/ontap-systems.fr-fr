...
sidebar: sidebar 
keywords: AFF A900 
summary: Le support de démarrage contient un ensemble principal et un ensemble secondaire de fichiers système que le système utilise lors du démarrage. Selon la configuration de votre réseau, vous pouvez effectuer un remplacement sans interruption de service ou avec interruption de service. 
---
= Remplacez le support de démarrage - AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
