...
== Étape 7 : installez le module LED USB sur le châssis de remplacement

Une fois le châssis de remplacement installé dans le rack ou l'armoire, installez le module LED USB de l'avant du châssis défectueux au châssis de remplacement.
...
|===
. Localisez le module LED USB à l'avant du châssis défectueux, directement sous les modules DCPM.
. Appuyez sur le bouton de verrouillage noir situé sur le côté droit du module pour le libérer du châssis, puis faites-le glisser hors du châssis défectueux.
. Alignez les bords du module avec la baie LED USB située en bas à l'avant du châssis de remplacement, puis poussez doucement le module jusqu'à ce qu'il s'enclenche.
...
Après avoir installé le module de contrôleur et tout autre composant dans le châssis de remplacement, démarrez-le à un état dans lequel vous pouvez exécuter le test de diagnostic d'interconnexion.
