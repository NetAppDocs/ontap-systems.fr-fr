...
summary: 'Le module NVRAM se compose du NVRAM11, des DIMM et de jusqu"à deux modules de cache Flash SSD NVMe par module NVRAM.' 
---
...
+
image::../media/drw_a900_move-remove_NVRAM_module.svg[Retirez le module NVRAM]
...
+
image::../media/drw_a900_remove_NVRAM_module_contents.svg[Retirez le contenu du module NVRAM]
