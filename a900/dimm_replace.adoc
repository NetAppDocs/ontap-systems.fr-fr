...
+
image::../media/drw_a900_PCM_open.png[drw a900 PCM ouvert]
...
image::../media/drw_a900_DIMM_map.png[Carte DIMM drw a900]
...
+
image::../media/drw_a900_replace_PCM_dimms.png[l'drw a900 remplace les modules dimm PCM]
