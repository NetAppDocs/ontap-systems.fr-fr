...
summary: 'Remplacez une barrette DIMM de votre module contrôleur AFF A900 lorsque le système enregistre un nombre croissant de codes de correction d"erreurs corrigibles ou d"erreurs ECC non corrigibles. Le non-remplacement d"une barrette DIMM défectueuse peut entraîner un blocage du système.' 
---
= Remplacez un module DIMM - AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_a900_remove_PCM.svg[Relâcher le contrôleur]
...
+
image::../media/drw_a900_PCM_open.svg[Soulevez le capot pour le retirer du module de contrôleur]
...
+
image::../media/drw_a900_replace_PCM_dimms.svg[Retirez un module DIMM]
