...
---
= Arrêter le contrôleur pour la récupération manuelle du support de démarrage - AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Si votre système de stockage exécute ONTAP 9.17.1 ou une version ultérieure, utilisez la procédure de récupération de démarrage automatique.  Si votre système exécute une version antérieure d’ ONTAP, vous devez utiliser le processus de récupération de démarrage manuel.
