...
. Si vous avez installé un module d'E/S de stockage, installez et connectez les câbles de vos tiroirs NS224, comme indiqué dans la section https://["Ajout à chaud d'un tiroir disque NS224"^].
...
Module d'E/S NIC avec moins de ports
 a| 
Réallouer de manière définitive les LIF affectées à un autre port de départ. Voir https://["Migration d'une LIF"^] Pour plus d'informations sur l'utilisation de System Manager pour déplacer définitivement les LIF.
...
Module d'E/S NIC avec module d'E/S de stockage
 a| 
Utilisez System Manager pour migrer définitivement les LIF vers différents ports de base, comme décrit dans la https://["Migration d'une LIF"^].
...
NOTE: Si vous rencontrez un problème pendant le redémarrage, reportez-vous à la section https://["BURT 1494308 - l'arrêt de l'environnement peut être déclenché lors du remplacement du module d'E/S."]
...
Module de stockage
 a| 
Installez et connectez les câbles de vos étagères NS224, comme indiqué dans la sectionhttps://["Ajout à chaud d'un tiroir disque NS224"^].
