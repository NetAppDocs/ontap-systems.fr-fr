...
[role="lead"]
Vous pouvez ajouter un module d'E/S à votre système de stockage AFF A900 lorsque des emplacements vides sont disponibles ou lorsque tous les emplacements sont entièrement remplis.
