...
---
= Remplacez un ventilateur - AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
IMPORTANT: Vous devez remplacer le module de ventilation dans les deux minutes qui suivent son retrait du châssis. Le flux d'air du système est interrompu et le module de contrôleur ou les modules s'arrêtent au bout de deux minutes pour éviter toute surchauffe.
