...
Le schéma ci-dessous montre une représentation de ce à quoi ressemble un système classique et de l'emplacement des principaux composants à la lecture du système :
...
+
image::../media/drw_9000_cable_console_switch_controller_IEOPS-953.svg[drw 9000 contrôleur de commutateur de console de câbles IEOPS 953]
