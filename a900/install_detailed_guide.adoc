...
X66240A-5 (112-00600), 5 m
 a| 
image::../media/oie_cable_sfp_gbe_copper.svg[SFP cuivre GbE]
 a| 
Câble réseau
...
X66100-5 (112-00544), 5 m
 a| 
image::../media/oie_cable100_gbe_qsfp28.svg[SFP cuivre GbE]
 a| 
...
X66033A (112-00438), 3 M.
 a| 
image::../media/oie_cable_fiber_lc_connector.svg[Connecteur à fibre LC]
 a| 
Réseau optique FC
...
X6562-R6 (112-00196), 5 m
 a| 
image::../media/oie_cable_rj45.svg[Connecteur de câble RJ-45]
 a| 
...
Sans objet
 a| 
image::../media/oie_cable_micro_usb.svg[Connecteur micro USB]
 a| 
...
Sans objet
 a| 
image::../media/oie_cable_power.svg[Connecteur du câble d'alimentation]
 a| 
...
| Étape | Effectuer des opérations sur chaque contrôleur 
 ...
 a| 
image::../media/oie_legend_icon_1_lg.svg[Légende 1]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[Connecteur 100 GB]



 a| 
image::../media/oie_legend_icon_2_lp.svg[Icône de trait de coupe 2]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[Connecteur de câble 100 GbE]



 a| 
image:../media/oie_legend_icon_4_dr.svg["Icône de légende quatre"]
 a| 
...
image:../media/oie_cable_sfp_gbe_copper.svg["SFP cuivre GbE"]
 ...
 a| 
image::../media/oie_legend_icon_5_lp.png[Légende cinq]
 a| 
...
image:../media/oie_cable_power.svg["Câble d'alimentation"]
...
image:../media/oie_cable100_gbe_qsfp28.svg["Câble 100 GbE"]



 a| 
image:../media/oie_legend_icon_2_lo.svg["Icône de trait de coupe 2"]
 a| 
Reliez les ports de gestion du contrôleur (clé en charge).
...
image::../media/drw_a900fas9500_power_icon_IEOPS-1142.svg[drw a9009500 icône de puissance du fas9500 IEOPS 1142]
...
image::../media/oie_cable_pull_tab_down.svg[direction de la languette de tirage du câble]
...
| Étape | Effectuer des opérations sur chaque contrôleur 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[Légende numéro un]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[Connecteur QSFP 100 GbE]
...
Câble 100 GbE
 ...
 a| 
image::../media/oie_legend_icon_2_lo.svg[Légende numéro deux]
 a| 
...
| Étape | Effectuer des opérations sur chaque contrôleur 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[Légende 1]
 a| 
...
Capuchon d'extrémité de tablette
 ...
 a| 
image::../media/legend_icon_02.png[Icône de trait de coupe 2]
 a| 
Plateau de tablette
 ...
 a| 
image::../media/legend_icon_03.png[Icône de légende trois]
 a| 
LED de l'ID de tiroir
 ...
 a| 
image::../media/legend_icon_04.png[Icône de légende quatre]
 a| 
