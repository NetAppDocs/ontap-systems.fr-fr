...
sidebar: sidebar 
keywords: AFF A900 
summary: 'Pour remplacer à chaud un module d"alimentation de contrôleur de désétage, qui contient la batterie NVRAM11, localisez le module DCPM défectueux, retirez-le du châssis et installez le module DCPM de remplacement.' 
---
