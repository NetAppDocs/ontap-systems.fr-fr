...
---
= Récupération automatique du support de démarrage à partir du nœud partenaire - AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
