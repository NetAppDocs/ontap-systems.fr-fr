...
summary: 'Remplacez une barrette DIMM dans le module contrôleur de votre AFF A700s lorsque le système enregistre un nombre croissant de codes de correction d"erreurs corrigibles ou d"erreurs ECC non corrigibles. Le non-remplacement d"une barrette DIMM défectueuse peut entraîner un blocage du système.' 
---
