...
summary: 'Restaurez la configuration de chiffrement sur le support de démarrage de remplacement pour un système AFF A700s . Le système AFF A700s ne prend en charge que les procédures de récupération manuelles du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
= Restaurer le chiffrement - AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
