...
summary: Pour rétablir le fonctionnement complet de votre système, vous devez restaurer la configuration du chiffrement du stockage NetApp, installer les licences pour le nouveau contrôleur et retourner la pièce défaillante à NetApp. 
---
= Restauration complète du système - FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
