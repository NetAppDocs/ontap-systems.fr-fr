...
summary: 'Démarrez l"image de récupération ONTAP à partir de la clé USB sur un système FAS2700 pour restaurer le support de démarrage. Le système FAS2700 ne prend en charge que les procédures de récupération manuelle du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge.' 
---
= Démarrez l'image de restauration - FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
