...
summary: Vous pouvez arrêter ou prendre le contrôle du contrôleur défaillant en utilisant différentes procédures, selon la configuration matérielle du système de stockage. Le système FAS2700 ne prend en charge que les procédures de récupération manuelle du support de démarrage. 
---
= Arrêtez le contrôleur défectueux - FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez ou prenez le contrôle du contrôleur défaillant en utilisant la procédure appropriée à votre configuration. Le système FAS2700 ne prend en charge que les procédures de récupération manuelle du support de démarrage. La récupération automatique du support de démarrage n'est pas prise en charge.
