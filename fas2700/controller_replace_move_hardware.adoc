...
---
= Remplacez le matériel du module de contrôleur - AFF A220 et FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Étape 3 : déplacer le support de démarrage
...
+
image::../media/drw_2600_boot_media_repl_animated_gif.png[image gif animée du remplacement du support de démarrage drw 2600]
...
== Étape 5 : déplacer un module de mise en cache, le cas échéant

Si votre système AFF A220 ou FAS2700 est équipé d'un module de cache, vous devez transférer le module de cache de l'ancien contrôleur vers le module de contrôleur de remplacement. Le module de mise en cache est appelé « carte PCIe M.2 » sur l'étiquette du module de contrôleur.
...
+
Appuyez uniquement sur `Ctrl-C` après que vous ayez vu le `Press Ctrl-C for Boot Menu` messagerie.
