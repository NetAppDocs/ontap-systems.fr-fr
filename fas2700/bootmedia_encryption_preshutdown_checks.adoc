...
---
= Vérifiez les clés de chiffrement intégrées : AFF A220 et FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** Si <lno-DARE> n'est pas affiché dans la sortie de la commande et que le système exécute ONTAP 9.5, passer à  1: Checking NVE or NSE on systems running ONTAP 9.5 and earlier.
** Si <lno-DARE> ne s'affiche pas dans la sortie de la commande et si le système exécute ONTAP 9.6 ou une version ultérieure, passer à  2: Checking NVE or NSE on systems running ONTAP 9.6 and later.
