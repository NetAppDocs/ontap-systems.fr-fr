...
---
= Déplacer et remplacer le matériel - AFF A220 et FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Après avoir installé le module de contrôleur et tous les autres composants dans le nouveau châssis, démarrez le système.
