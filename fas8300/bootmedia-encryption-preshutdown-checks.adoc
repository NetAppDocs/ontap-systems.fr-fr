...
---
= Vérifiez la prise en charge et l'état de la clé de cryptage - AFF FAS8300 et FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Selon que votre système utilise le Gestionnaire de clés externe ou le Gestionnaire de clés intégré, sélectionnez l'une des options suivantes.
+
[role="tabbed-block"]
====
