...
---
= Remplacement à chaud d'un module de ventilation - FAS8300 et FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Utilisez le message BMC ou la LED d'attention pour identifier le module de ventilateur à remplacer. BMC associe les modules de ventilateur au format Fan#_#, où le premier nombre correspond à l'emplacement et le second à la rangée (1=haut, 2=bas) ; par exemple, emplacement 1, deuxième rangée = Fan1_2.
...
+
La LED d'avertissement s'éteint une fois le ventilateur en place et ayant atteint sa vitesse de fonctionnement.
