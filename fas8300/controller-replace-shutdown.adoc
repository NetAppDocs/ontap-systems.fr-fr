...
summary: Éteignez le contrôleur de votre système de stockage FAS8300 et FAS8700 pour éviter toute perte de données et garantir la stabilité du système lors du remplacement du contrôleur. 
---
...
[role="lead"]
Éteignez le contrôleur de votre système de stockage FAS8300 et FAS8700 pour éviter toute perte de données et garantir la stabilité du système lors du remplacement du contrôleur.
...
====
.Et la suite ?
Après avoir arrêté les contrôleurs FAS8300 et FAS8700, vous devez link:controller-replace-move-hardware.html["remplacer le contrôleur"].
