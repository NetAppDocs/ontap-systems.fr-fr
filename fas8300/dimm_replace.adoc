...
[role="lead"]
Après avoir remplacé un module DIMM système de votre système, vous devez exécuter des tests de diagnostic sur ce composant.
...
. Sélectionnez une option dans le sous-menu affiché et exécutez le test.
