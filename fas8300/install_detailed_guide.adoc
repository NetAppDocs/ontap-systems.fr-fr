...
. Accédez à  4: Cable controllers to drive shelves pour obtenir les instructions de câblage du tiroir disque.
...
. Accédez à  5: Complete system setup and configuration pour terminer l'installation et la configuration du système.
