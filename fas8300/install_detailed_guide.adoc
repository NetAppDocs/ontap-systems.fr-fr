...
http://["Retrouvez les notes de mise à jour de votre version de ONTAP 9"^]
...
+
https://["Guide de configuration de ONTAP"]
...
+
image::../media/drw_fas8300_TNSC_network_cabling.png[Câblage réseau TNSC drw fas8300]
...
+
image::../media/drw_fas8300_switched_network_cabling.png[câblage réseau commuté drw fas8300]
...
+
image::../media/drw_fas8300_three-ds224c_shelves.png[drw fas8300 trois étagères ds224c]
