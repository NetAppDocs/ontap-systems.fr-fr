...
summary: Arrêtez le contrôleur défectueux de votre système de stockage FAS8300 ou FAS8700 pour éviter la perte de données et garantir la stabilité du système lors du remplacement du support de démarrage. 
---
= Arrêter le contrôleur pour la récupération automatique du support de démarrage - FAS8300 et FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez le contrôleur défectueux de votre système de stockage FAS8300 ou FAS8700 pour éviter la perte de données et garantir la stabilité du système lors du remplacement du support de démarrage.
