...
image::../media/drw_8300_empty_riser_remove.png[Retirez la carte de montage vide]
...
image::../media/drw_A400_Replace-mezz-card.png[Retirez la carte mezzanine]
...
image::../media/drw_A400_Replace-flashcache.png[Retirez et remplacez le module de cache]
