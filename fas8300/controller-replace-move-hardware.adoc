...
summary: Remplacez le contrôleur de votre FAS8300 ou FAS8700 lorsque cela est requis en cas de défaillance matérielle. Retirez le contrôleur défectueux, transférez ses composants vers le contrôleur de remplacement, installez le nouveau contrôleur et redémarrez-le. 
---
= Remplacez le contrôleur - FAS8300 et FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le contrôleur de votre FAS8300 ou FAS8700 lorsque cela est requis en cas de défaillance matérielle. Retirez le contrôleur défectueux, transférez ses composants vers le contrôleur de remplacement, installez le nouveau contrôleur et redémarrez-le.


NOTE: Le module de contrôleur ver2 n'a qu'un seul support de module de cache (emplacement 6) dans le FAS8300. Le modèle FAS8700 ne dispose pas d'un module de contrôleur VER2. La fonctionnalité du module de cache n'est pas affectée par le retrait du socket.
...
Déplacez les cartes d'extension PCIe et la carte mezzanine vers le module de contrôleur de remplacement.
...
== Étape 6 : Déplacer le module de cache

Déplacez le module cache vers le module contrôleur de remplacement.
...
== Étape 7 : déplacez les modules DIMM
...
.Et la suite ?
Après avoir remplacé le contrôleur FAS8300 ou FAS8700 défectueux, vous devez link:controller-replace-system-config-restore-and-verify.html["restaurez la configuration du système"].
