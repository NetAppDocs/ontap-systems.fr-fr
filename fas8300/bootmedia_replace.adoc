...
.Avant de commencer
Bien que le contenu du support de démarrage soit chiffré, il est conseillé d'effacer le contenu du support de démarrage avant de le remplacer. Pour plus d'informations, reportez-vous à la section https://["Rapport de volatilité"] De votre système sur le site de support NetApp.
