...
---
= Remplacez la pile de l'horloge temps réel - FAS8300 et FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Étape 4 : réinstallez le module de contrôleur et sett time/date après le remplacement de la batterie RTC
