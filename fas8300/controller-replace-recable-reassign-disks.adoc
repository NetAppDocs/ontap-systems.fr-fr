...
summary: Rendez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système FAS8300 et FAS8700 puisse reprendre son fonctionnement normal. 
---
= Rendez le contrôleur - FAS8300 et FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Rendez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système FAS8300 et FAS8700 puisse reprendre son fonctionnement normal.
