...
summary: Avant de remplacer le support de démarrage de votre système FAS8300 ou FAS8700 , assurez-vous de répondre aux exigences nécessaires pour un remplacement réussi. 
---
= Exigences pour la récupération automatique du support de démarrage - FAS8300 et FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
