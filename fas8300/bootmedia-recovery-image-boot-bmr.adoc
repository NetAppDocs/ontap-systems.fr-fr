...
summary: Après avoir installé le nouveau périphérique de support de démarrage dans votre système FAS8300 ou FAS8700 , vous pouvez démarrer le processus de récupération automatique du support de démarrage pour restaurer la configuration à partir du nœud partenaire. 
---
= Récupération automatique du support de démarrage à partir du nœud partenaire - FAS8300 et FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
