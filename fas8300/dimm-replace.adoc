...
summary: 'Vous devez remplacer une barrette DIMM dans le contrôleur lorsque votre système de stockage rencontre des erreurs telles qu"un nombre excessif de codes de correction d"erreurs corrigibles ou des erreurs non corrigibles, généralement causées par la défaillance d"une seule barrette DIMM empêchant le système de stockage de démarrer ONTAP.' 
---
