...
---
= Recâblage du système et réaffectation de disques - FAS8300 et FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous devez effectuer une série de tâches avant de restaurer le système en mode de fonctionnement complet.
