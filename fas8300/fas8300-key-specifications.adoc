...
summary: Spécifications clés du FAS8300 
---
= Spécifications clés du FAS8300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Voici quelques spécifications sélectionnées pour le système de stockage FAS8300 dans une seule paire haute disponibilité.  Visitez NetApp Hardware Universe (HWU) pour obtenir les spécifications complètes de ce système de stockage.



== Aperçu des spécifications du FAS8300

* Configuration de la plateforme : FAS8300, châssis simple, paire HA, bundle Ethernet
...
* Puissance typique : 4024 BTU/h
* Consommation d'énergie dans le pire des cas : 5 017 BTU/h
* Poids : 108,5 lb 49,2 kg
* Hauteur : 4U
