...
summary: 'Terminez le remplacement du contrôleur de votre système FAS8300 et FAS8700. Installez les licences du contrôleur de remplacement, vérifiez que les interfaces logiques (LIF) sont signalées sur leurs ports d"origine et effectuez une vérification de l"état du cluster. Enfin, retournez la pièce défectueuse à NetApp.' 
---
= Remplacement complet du contrôleur - FAS8300 et FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Terminez le remplacement du contrôleur de votre système FAS8300 et FAS8700. Installez les licences du contrôleur de remplacement, vérifiez que les interfaces logiques (LIF) sont signalées sur leurs ports d'origine et effectuez une vérification de l'état du cluster. Enfin, retournez la pièce défectueuse à NetApp.
