...
Vous pouvez utiliser les animations et illustrations suivantes. Ou les étapes écrites pour déplacer les cartes de montage PCIe et la carte mezzanine du module de contrôleur pour facultés affaiblies vers le module de contrôleur de remplacement.
