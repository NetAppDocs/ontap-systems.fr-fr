...
summary: Vous devez remplacer la NVDIMM dans le module contrôleur lorsque votre système détecte que la durée de vie de la mémoire flash est presque terminée ou que la NVDIMM identifiée est globalement défectueuse. 
---
