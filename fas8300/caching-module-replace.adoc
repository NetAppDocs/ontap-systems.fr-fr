...
summary: Vous devez remplacer le module de cache dans le module de contrôleur lorsque votre système enregistre un seul AutoSupport message indiquant que le module est hors ligne. 
---
