...
summary: Le support de démarrage contient un ensemble principal et un ensemble secondaire de fichiers image de démarrage système que le système utilise lors du démarrage. Selon la configuration de votre réseau, vous pouvez effectuer un remplacement sans interruption de service ou avec interruption de service. 
---
= Présentation du remplacement du support de démarrage - AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
