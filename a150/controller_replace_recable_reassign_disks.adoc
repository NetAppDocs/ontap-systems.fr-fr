...
Paire HA
 a| 
link:controller_replace_complete_system_restoration.md#["Vérification de la modification de l'ID du système sur un système HA"]
...
Autonome
 a| 
link:controller_replace_complete_system_restoration.md#["Réaffectation manuelle de l'ID système sur un système autonome dans ONTAP"]
...
Configuration MetroCluster à deux nœuds
 a| 
link:controller_replace_complete_system_restoration.md#["Réaffectation manuelle de l'ID système sur les systèmes d'une configuration MetroCluster à deux nœuds"]
...
+
http://["Recherchez le contenu Configuration haute disponibilité de votre version de ONTAP 9"]
