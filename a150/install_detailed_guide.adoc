...
[role="lead"]
Apprenez à installer votre système AFF A150.
...
[role="lead"]
Pour installer votre système AFF A150, créez un compte sur le site de support NetApp, enregistrez votre système et obtenez vos clés de licence. Vous devez également inventorier le nombre et le type de câbles appropriés pour votre système et collecter des informations réseau spécifiques.
...
.. https://["Enregistrez votre système"].


. Téléchargez et installez https://["Config Advisor"] sur votre ordinateur portable.
. Faites un inventaire et notez le nombre et le type de câbles que vous avez reçus.
+
Le tableau suivant identifie les types de câbles que vous pouvez recevoir. Si vous recevez un câble non répertorié dans le tableau, reportez-vous à la section https://["NetApp Hardware Universe"] pour localiser le câble et identifier son utilisation.
...
|===
. https://["Téléchargez et remplissez la fiche de configuration du cluster"].
...
+
.. Connectez-vous à votre https://["compte existant ou créer et compte"].
.. https://["S'inscrire"] votre système.
.. Télécharger https://["Active IQ Config Advisor"].


. Vérifiez l'état de santé de votre système en exécutant Config Advisor.
. Une fois la configuration initiale terminée, passez à la https://["Documentation ONTAP"] Pour plus d'informations sur la configuration de fonctions supplémentaires dans ONTAP.
...
NOTE: Le format de l'adresse est https://[].
