...
[role="lead"]
Pour installer votre système AFF A150, vous devez créer un compte sur le site de support NetApp, enregistrer votre système et obtenir des clés de licence. Vous devez également inventorier le nombre et le type de câbles appropriés pour votre système et collecter des informations réseau spécifiques.
...
+
https://["Fiche de configuration du cluster"]
...
|===
. Pour câbler votre espace de stockage, reportez-vous à la section link:install_detailed_guide.md#["Câblage des contrôleurs aux tiroirs disques"]
...
+
link:../com.netapp.doc.hw-ds-sas3-icg/home.html["Installation et câblage"]
