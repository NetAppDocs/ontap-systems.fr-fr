...
summary: Pour rétablir le fonctionnement complet de votre système, vous devez restaurer la configuration du chiffrement du stockage NetApp si nécessaire, installer les licences pour le nouveau contrôleur et renvoyer la partie défaillante à NetApp. 
---
= Restauration complète du système - AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
