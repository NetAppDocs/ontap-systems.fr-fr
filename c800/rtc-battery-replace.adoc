...
summary: 'Remplacez la pile de l"horloge temps réel, communément appelée pile bouton, dans votre AFF C800 pour garantir que les services et applications nécessitant une synchronisation horaire précise restent opérationnels.' 
---
= Remplacez la pile de l'horloge temps réel - AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la pile de l'horloge temps réel (RTC), communément appelée pile bouton, de votre système AFF C800 pour garantir le bon fonctionnement des services et applications nécessitant une synchronisation horaire précise.
