...
.Et la suite ?
Après avoir remplacé le châssis défectueux de AFF C800 et réinstallé les composants, vous devez :link:chassis-replace-complete-system-restore-rma.html["terminez le remplacement du châssis"]
