...
summary: 'Cette section fournit des instructions détaillées pour l"installation d"un système AFF C800.' 
---
= Étapes détaillées - AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cette section fournit des instructions détaillées pour l'installation d'un système AFF C800.
...
Pour installer votre système AFF C800, vous devez créer un compte et enregistrer le système. Vous devez également inventorier le nombre et le type de câbles appropriés pour votre système et collecter des informations réseau spécifiques.
...
+
link:../com.netapp.doc.hw-rail-superrail/home.html["Installation de SuperRail dans un rack à quatre montants"^]
...
+
image::../media/drw_affa800_weight_caution.png[attention de poids du drw affa800]

. Fixez les dispositifs de gestion des câbles (comme illustré).
+
image::../media/drw_affa800_install_cable_mgmt.png[drw affa800 installation de la gestion de câble]
...
** e0b à e0b
** e1b à e1bimage:../media/drw_affa800_ha_pair_cabling.png[""]
...
** e0a à e0a
** e1a à e1aimage:../media/drw_affa800_tnsc_clust_cabling.png[""]
...
image:../media/oie_legend_icon_3_lp.png[""]
 a| 
Reliez les ports de gestion aux switchs réseau de gestion image:../media/drw_affa800_mgmt_cabling.png[""]
...
image:../media/oie_legend_icon_2_lg.png[""]
 a| 
Reliez les ports d'interconnexion de cluster aux commutateurs d'interconnexion de cluster 100 GbE. ** e0a ** e1aimage:../media/drw_affa800_switched_clust_cabling.png[""]
...
1
 a| 
Reliez les ports 2a à 2d aux commutateurs hôte FC.image:../media/drw_affa800_fc_host_cabling.png[""]
...
1
 a| 
Reliez les ports e4a à e4d aux commutateurs du réseau hôte 10GbE.image:../media/drw_affa800_10gbe_host_cabling.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
Connectez les câbles du contrôleur A au tiroir : image:../media/drw_affa800_1shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
Câble du contrôleur B vers le tiroir : image:../media/drw_affa800_1shelf_cabling_b.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
Connectez les câbles du contrôleur A aux tiroirs. image:../media/drw_affa800_2shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
Connectez les câbles du contrôleur B aux tiroirs. image:../media/drw_affa800_2shelf_cabling_b.png[""]
...
+
image::../media/drw_console_connect_affa800.png[console drw connecter affa800]

.. Connectez l'ordinateur portable ou la console au commutateur du sous-réseau de gestion.
+
image::../media/drw_client_mgmt_subnet_affa800.png[sous-réseau de gestion client drw affa800]
