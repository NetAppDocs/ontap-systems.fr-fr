...
summary: Avant de remplacer le support de démarrage de votre système AFF C800, assurez-vous de respecter les conditions requises pour un remplacement réussi. 
---
= Conditions requises pour la récupération automatique du support de démarrage - AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
