...
summary: 'Remplacez une barrette DIMM dans votre système AFF C800 si un nombre excessif d"erreurs de mémoire corrigibles ou non corrigibles est détecté. De telles erreurs peuvent empêcher le système de stockage de démarrer ONTAP.' 
---
= Remplacez un module DIMM - AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
