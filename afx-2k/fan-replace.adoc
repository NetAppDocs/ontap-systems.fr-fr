...
summary: Remplacez un module de ventilateur défaillant ou défectueux dans votre système afx 2k afin de garantir un refroidissement optimal et de prévenir les problèmes de performances du système. Les ventilateurs sont remplaçables à chaud et peuvent être remplacés sans arrêter le système. 
---
= Remplacez un ventilateur - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez un module de ventilateur défectueux de votre système AFX 2K pour assurer un refroidissement optimal et éviter les problèmes de performances. Les ventilateurs sont remplaçables à chaud et peuvent être remplacés sans éteindre le système. Cette procédure comprend l'identification du ventilateur défectueux à l'aide des messages d'erreur de la console et des indicateurs LED, le retrait du panneau, le remplacement du module de ventilateur et le retour de la pièce défectueuse à NetApp.
