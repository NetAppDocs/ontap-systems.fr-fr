...
summary: Commencez à remplacer le châssis de votre système de stockage afx 2k en consultant les exigences de remplacement, en arrêtant le contrôleur, en remplaçant le châssis et en vérifiant le fonctionnement du système. 
---
= Processus de remplacement du châssis - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Commencez à remplacer le châssis de votre système de stockage AFX 2K en consultant les exigences de remplacement, en arrêtant le contrôleur, en remplaçant le châssis et en vérifiant le fonctionnement du système.
