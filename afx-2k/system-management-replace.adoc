...
summary: 'Remplacez le module de gestion système de votre système de stockage afx 2k lorsqu"il est défectueux ou que son micrologiciel est corrompu. La procédure de remplacement comprend l"arrêt du contrôleur, le remplacement du module de gestion système défectueux, le redémarrage du contrôleur, la mise à jour des clés de licence et le renvoi de la pièce défectueuse à NetApp.' 
---
= Remplacez le module de gestion système - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le module de gestion système de votre système de stockage AFX 2K lorsqu'il est défectueux ou que son micrologiciel est corrompu. La procédure de remplacement comprend l'arrêt du contrôleur, le remplacement du module de gestion système défectueux, le redémarrage du contrôleur, la mise à jour des clés de licence et le renvoi de la pièce défectueuse à NetApp.
...
+
image::../media/drw_afx_2k_sys_mgmt_remove_replace_ieops-2880.svg[Remplacez le module de gestion du système]
...
+
image::../media/drw_afx_2k_boot_media_remove_replace_ieops-2877.svg[Remplacement du support de démarrage]
