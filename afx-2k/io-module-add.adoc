...
summary: 'Ajoutez un module d"E/S à votre système de stockage afx 2k pour améliorer la connectivité réseau et étendre la capacité de votre système à gérer le trafic de données.' 
---
= Ajouter un module d'E/S - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ajoutez un module d'E/S à votre système de stockage AFX 2K pour améliorer la connectivité réseau et étendre la capacité de votre système à gérer le trafic de données.

Vous pouvez ajouter un module d'E/S à votre système de stockage AFX 2K lorsqu'il y a des emplacements vides disponibles ou lorsque tous les emplacements sont entièrement occupés.
