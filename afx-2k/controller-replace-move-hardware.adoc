...
summary: Remplacez le contrôleur de votre système de stockage afx 2k lorsque cela est requis par une défaillance matérielle. La procédure de remplacement consiste à retirer le contrôleur défectueux, à transférer les composants vers le contrôleur de remplacement, à installer le contrôleur de remplacement et à le redémarrer. 
---
= Remplacez le contrôleur - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le contrôleur de votre système de stockage AFX 2K lorsqu'une défaillance matérielle l'exige. La procédure de remplacement consiste à retirer le contrôleur défectueux, à transférer les composants vers le contrôleur de remplacement, à installer le contrôleur de remplacement et à le redémarrer.
...
+
Le DIMM s'insère parfaitement dans l'emplacement, mais vous devriez pouvoir l'insérer facilement.  Sinon, réalignez le DIMM avec l’emplacement et réinsérez-le.
...
.Et la suite ?
Après avoir remplacé le contrôleur AFX 2K défectueux, link:controller-replace-system-config-restore-and-verify.html["restaurer les paramètres du système"].
