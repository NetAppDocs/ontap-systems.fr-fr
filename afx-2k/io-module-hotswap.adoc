...
summary: 'Vous pouvez remplacer à chaud un module d"E/S Ethernet dans votre système de stockage afx 2k si un module tombe en panne et si votre système de stockage répond à toutes les exigences de version ONTAP.' 
---
= Remplacer à chaud un module d'E/S - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer à chaud un module d'E/S Ethernet dans votre système de stockage AFX 2K si un module tombe en panne et si votre système de stockage répond à toutes les exigences de version ONTAP.
...
Directive non résolue dans stdin - include::../_include/afx_2k_io_module_hotswap_replace.adoc[]
