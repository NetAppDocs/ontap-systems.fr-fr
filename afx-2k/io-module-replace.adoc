...
summary: 'Remplacez un module d"E/S de votre système de stockage afx 2k lorsqu"il tombe en panne ou nécessite une mise à niveau pour offrir des performances supérieures ou des fonctionnalités supplémentaires. La procédure de remplacement consiste à arrêter le contrôleur, à remplacer le module d"E/S défectueux, à redémarrer le contrôleur et à retourner la pièce défectueuse à NetApp.' 
---
= Remplacez le module d'E/S - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez un module d'E/S de votre système de stockage AFX 2K lorsqu'il tombe en panne. La procédure de remplacement consiste à arrêter le contrôleur, à remplacer le module d'E/S défectueux, à redémarrer le contrôleur et à retourner la pièce défectueuse à NetApp.
...
NOTE: L'illustration suivante montre le retrait d'un module d'E/S vertical. En règle générale, vous ne retirerez qu'un seul module d'E/S.
