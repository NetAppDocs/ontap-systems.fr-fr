...
summary: 'Remplacez une barrette DIMM de votre système de stockage afx 2k si un nombre excessif d"erreurs de mémoire, corrigibles ou non, est détecté. Ces erreurs peuvent empêcher le système de stockage de démarrer ONTAP. La procédure de remplacement consiste à arrêter le contrôleur défectueux, à le retirer, à remplacer la barrette DIMM, à réinstaller le contrôleur, puis à retourner la pièce défectueuse à NetApp.' 
---
= Remplacez une barrette DIMM - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez une barrette DIMM de votre système de stockage AFX 2K si un nombre excessif d'erreurs de mémoire, corrigibles ou non, est détecté. Ces erreurs peuvent empêcher le système de stockage de démarrer ONTAP. La procédure de remplacement consiste à arrêter le contrôleur défectueux, à le retirer, à remplacer la barrette DIMM, à réinstaller le contrôleur, puis à retourner le composant défectueux à NetApp.
