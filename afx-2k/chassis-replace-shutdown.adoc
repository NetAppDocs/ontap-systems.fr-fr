...
summary: Éteignez le contrôleur de votre système de stockage afx 2k pour éviter toute perte de données et garantir la stabilité du système lors du remplacement du châssis. 
---
= Éteignez le contrôleur pour remplacer le châssis - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Éteignez le contrôleur de votre système de stockage AFX 2K pour éviter toute perte de données et garantir la stabilité du système lors du remplacement du châssis.
