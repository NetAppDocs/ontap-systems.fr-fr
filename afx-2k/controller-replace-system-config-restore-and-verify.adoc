...
summary: 'Vérifiez que la configuration HA du contrôleur est active et fonctionne correctement dans votre système de stockage afx 2k, et confirmez que les adaptateurs du système listent tous les chemins d"accès aux disques.' 
---
= Restaurez et vérifiez la configuration système - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vérifiez que la configuration HA du contrôleur est active et fonctionne correctement dans votre système de stockage AFX 2K, et confirmez que les adaptateurs du système listent tous les chemins d'accès aux disques.
...
.Et la suite ?
Après avoir restauré et vérifié la configuration du système de stockage AFX 2K, link:controller-replace-recable-reassign-disks.html["remettez le contrôleur en place"].
