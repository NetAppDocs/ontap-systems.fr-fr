...
summary: Remplacez la NVRAM de votre système de stockage afx 2k lorsque la mémoire non volatile devient défectueuse ou nécessite une mise à niveau. 
---
= Remplacer NVRAM - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la NVRAM de votre système de stockage AFX 2K lorsque la mémoire non volatile est défectueuse ou nécessite une mise à niveau. La procédure de remplacement consiste à arrêter le contrôleur défectueux, à remplacer le module NVRAM ou la NVRAM DIMM, puis à renvoyer la pièce défectueuse à NetApp.
...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Retirez le module NVRAM12 et les modules DIMM]
...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Retirez le module NVRAM 12 et les modules DIMM]
...
NOTE: L'identifiant système de remplacement est uniquement requis pour le remplacement du module NVRAM et non pour le remplacement de la barrette DIMM NVRAM.
...
+
.. À partir du contrôleur sain, restituez le stockage du contrôleur remplacé : `_storage failover giveback -ofnode impaired_node_name_`
+
