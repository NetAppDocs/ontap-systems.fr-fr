...
summary: 'Remplacez la pile de l"horloge temps réel de votre système de stockage afx 2k pour garantir que les services et applications reposant sur une synchronisation horaire précise restent opérationnels.' 
---
= Remplacez la pile de l'horloge temps réel - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la pile de l'horloge temps réel (RTC), communément appelée pile bouton, de votre système de stockage AFX 2K afin de garantir que les services et applications dépendant d'une synchronisation horaire précise restent opérationnels.
