...
summary: Après avoir installé le nouveau périphérique de démarrage dans votre système de stockage afx 2k, vous pouvez lancer le processus de récupération automatisée du support de démarrage pour restaurer la configuration à partir du nœud partenaire. 
---
= Démarrez l'image de récupération - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir installé le nouveau périphérique de démarrage dans votre système de stockage AFX 2K, vous pouvez lancer le processus de récupération automatisée du support de démarrage pour restaurer la configuration à partir du nœud partenaire.
...
+
Le processus tente de restaurer les fichiers appropriés à partir du nœud partenaire et redémarre le nœud. Passez à l'étape suivante.
