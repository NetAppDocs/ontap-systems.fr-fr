...
---
= Terminez le remplacement du châssis - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Redémarrez le contrôleur, vérifiez l'état du système et renvoyez la pièce défectueuse à NetApp pour terminer la dernière étape de la procédure de remplacement du châssis AFX 2K.
