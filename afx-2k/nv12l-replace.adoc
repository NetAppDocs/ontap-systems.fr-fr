...
summary: Remplacez la NVRAM12-EX de votre système de stockage AFX 2K lorsque la mémoire non volatile devient défectueuse ou nécessite une mise à niveau. 
---
= Remplacez NVRAM12-EX - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le module NVRAM12-EX de votre système de stockage AFX 2K lorsque la mémoire non volatile est défectueuse ou nécessite une mise à niveau. La procédure de remplacement consiste à arrêter le contrôleur défectueux, à remplacer le module NVRAM12-EX, la barrette DIMM NVRAM ou la batterie NVRAM, puis à renvoyer la pièce défectueuse à NetApp.
