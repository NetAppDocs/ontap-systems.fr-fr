...
summary: 'Arrêtez le contrôleur de votre système de stockage afx 2k en cas de dysfonctionnement. Avant toute opération de maintenance ou de remplacement de composant, il est essentiel d"arrêter le contrôleur en toute sécurité afin d"éviter la perte de données et de garantir la stabilité du système.' 
---
= Arrêtez le contrôleur défectueux - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Éteignez le contrôleur défectueux de votre système de stockage AFX 2K afin d'éviter toute perte de données et de garantir la stabilité du système lors du remplacement du contrôleur.
