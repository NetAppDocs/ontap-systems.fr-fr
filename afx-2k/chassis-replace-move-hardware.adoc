...
summary: 'Remplacez le châssis de votre système de stockage afx 2k lorsqu"une défaillance matérielle l"exige. La procédure de remplacement consiste à retirer le contrôleur situé à la face avant du châssis, à retirer les blocs d"alimentation, la NVRAM12, les modules d"E/S et leurs caches, ainsi que le module de gestion du système, puis à installer le châssis de remplacement et à réinstaller les composants du châssis.' 
---
= Remplacer le châssis - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le châssis de votre système de stockage AFX 2K lorsqu'une défaillance matérielle l'exige. La procédure de remplacement consiste à retirer le contrôleur, les cartes d'E/S, le module NVRAM12, le module de gestion du système et les blocs d'alimentation (PSU), à installer le châssis de remplacement, puis à réinstaller les composants du châssis.
...
+
image::../media/drw_afx_2k_psu_remove_replace_ieops-2882.svg[Retirer ou remplacer le bloc d'alimentation]
...
== Étape 2 : Retirez les cartes d’E/S, la NVRAM12, la NVRAM12-EX et le module de gestion du système

. Retirez le module d'E/S cible du châssis :
+
image:../media/drw_afx_2k_io_remove_replace_ieops-2878.svg["Retirez le module d'E/S."]
...
+
image::../media/drw_nvram1_remove_only_ieops-2574.svg[Retirez le module NVRAM12]
...
. Retirez le module NVRAM12-EX :
+
.. Saisissez la poignée du module et appuyez sur le bouton de came de verrouillage.
.. Retirez le module NVRAM12-EX du châssis tout en soutenant le bas du module avec votre autre main.
+
...
|===
 ...
 a| 
image:../media/icon_round_1.png["Légende numéro 1"]
| Poignée NVRAM12-EX et bouton de came 
|===
...
+
image::../media/drw_afx_2k_sys_mgmt_remove_replace_ieops-2880.svg[Gestion du système supprimer]
...
.Et la suite ?
Après avoir remplacé le châssis AFX 2K défectueux et réinstallé ses composants, terminez le link:chassis-replace-complete-system-restore-rma.html["remplacement du châssis"].
