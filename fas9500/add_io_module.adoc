...
. Si vous avez installé un module d'E/S de stockage, installez et connectez les câbles de vos tiroirs SAS, comme indiqué dans la https://["Ajout à chaud d'un tiroir SAS"^].
...
Module de stockage
 a| 
Installez et connectez les câbles de vos tiroirs SAS, comme décrit dans lahttps://["Ajout à chaud d'un tiroir SAS"^].
