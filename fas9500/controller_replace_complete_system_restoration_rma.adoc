...
summary: 'Pour effectuer la procédure de remplacement et restaurer le fonctionnement complet de votre système, vous devez recâter le stockage, restaurer la configuration NetApp Storage Encryption (si nécessaire) et installer les licences du nouveau contrôleur.' 
---
= Restauration complète du système - FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
