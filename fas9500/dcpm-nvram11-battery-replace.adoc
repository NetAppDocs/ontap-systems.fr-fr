...
sidebar: sidebar 
keywords: FAS9500 
summary: 'Pour remplacer à chaud un module d"alimentation DCPM du contrôleur de désétage, qui contient la batterie NVRAM11, vous devez localiser le module DCPM défectueux, le retirer du châssis et installer le module DCPM de remplacement.' 
---
...
+
image::../media/drw_a900_remove_NV_battery.svg[Remplacer la batterie NV (DCPM)]
