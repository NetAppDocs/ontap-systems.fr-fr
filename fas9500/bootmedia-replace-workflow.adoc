...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinq"]link:bootmedia-recovery-image.html["Démarrez l'image de récupération"]
[role="quick-margin-para"]
