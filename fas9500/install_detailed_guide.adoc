...
+
image::../media/drw_autodiscovery_controler_select_ieops-1849.svg[drw autodiscovery controler select ieops 1849]

+
.. Ouvrez l'Explorateur de fichiers.
.. Cliquez sur réseau dans le volet gauche, cliquez avec le bouton droit de la souris et sélectionnez Actualiser.
