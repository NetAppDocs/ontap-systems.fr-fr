...
summary: Avant de remplacer le support de démarrage de votre système FAS9500 , assurez-vous de répondre aux exigences nécessaires pour un remplacement réussi. 
---
= Exigences relatives à la récupération automatique du support de démarrage - FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
