...
X66033A (112-00438), 3 M.
 a| 
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png[Connecteur mini-SAS]
 a| 
Stockage
...
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png[Câble Mini-SAS HD]
...
+
image::../media/drw_a900_power-on_IEOPS-941.svg[Mettez le système sous tension]
