...
[role="lead"]
Vérifiez que les interfaces logiques (LIF) dépendent de leur port d'attache, vérifiez l'état du cluster, puis renvoyez la pièce défectueuse à NetApp pour effectuer la dernière étape de la procédure de remplacement des contrôleurs ASA A70 et ASA A90.
