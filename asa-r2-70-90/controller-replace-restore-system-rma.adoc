...
summary: 'Pour terminer le remplacement du contrôleur de votre système ASA A70 ou ASA A90, restaurez d"abord la configuration NetApp Storage Encryption si nécessaire. Ensuite, confirmez que les interfaces logiques rapportent à leurs ports d"attache et effectuez une vérification de l"état du cluster. Enfin, retournez la pièce défaillante à NetApp.' 
---
