...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Quatre"]link:bootmedia-recovery-image-boot-bmr.html["Image de restauration sur support de démarrage (restauration de démarrage automatique)"]
[role="quick-margin-para"]
