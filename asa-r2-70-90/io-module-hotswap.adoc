...
summary: 'Vous pouvez remplacer à chaud un module d"E/S Ethernet dans votre système de stockage ASA A70 ou ASA A90 si un module tombe en panne et si votre système de stockage répond à toutes les exigences de version ONTAP.' 
---
= Remplacer à chaud un module d'E/S - ASA A70 et ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer à chaud un module d'E/S Ethernet dans votre système de stockage ASA A70 ou ASA A90 si un module tombe en panne et si votre système de stockage répond à toutes les exigences de version ONTAP.
