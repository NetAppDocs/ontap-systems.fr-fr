...
summary: 'Arrêtez les contrôleurs de votre système de stockage ASA A70 ou ASA A90 lorsque vous devez remplacer le châssis. Il est essentiel d"arrêter les contrôleurs en toute sécurité pour éviter toute perte de données et assurer la stabilité du système.' 
---
= Arrêter les contrôleurs - ASA A70 et ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez les contrôleurs de votre système de stockage ASA A70 ou ASA A90 lorsque vous devez remplacer le châssis. Il est essentiel d'arrêter les contrôleurs en toute sécurité pour éviter toute perte de données et assurer la stabilité du système.
