...
summary: Arrêtez les contrôleurs de votre système de stockage ASA A70 ou ASA A90 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du châssis. 
---
= Arrêtez les contrôleurs pour remplacer le châssis - ASA A70 et ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez les contrôleurs de votre système de stockage ASA A70 ou ASA A90 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du châssis.
