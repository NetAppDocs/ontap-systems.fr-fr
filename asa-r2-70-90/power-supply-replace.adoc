...
summary: 'Remplacez le bloc d"alimentation CA ou CC de votre système ASA A70 ou ASA A90 en cas de panne ou de dysfonctionnement, afin de garantir que votre système continue de recevoir l"alimentation requise pour un fonctionnement stable. La procédure de remplacement consiste à déconnecter le bloc d"alimentation défectueux de la source d"alimentation, à débrancher le câble d"alimentation, à remplacer le bloc d"alimentation défectueux, puis à le reconnecter à la source d"alimentation.' 
---
= Remplacement à chaud d'une alimentation - ASA A70 et ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
