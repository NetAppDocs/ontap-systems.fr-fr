...
summary: 'Remplacez un module de ventilation de votre système ASA A70 ou ASA A90 en cas de panne ou de dysfonctionnement d"un ventilateur, ce qui peut affecter le refroidissement du système et les performances globales.' 
---
...
[role="lead"]
Remplacez un module de ventilation de votre système ASA A70 ou ASA A90 en cas de panne ou de dysfonctionnement d'un ventilateur, ce qui peut affecter le refroidissement du système et les performances globales.
