...
summary: 'Vérifiez que la configuration haute disponibilité du contrôleur est active et qu"elle fonctionne correctement sur votre système de stockage ASA A70 ou ASA A90, puis vérifiez que les adaptateurs du système répertorient tous les chemins d"accès aux disques.' 
---
...
[role="lead"]
Vérifiez que la configuration haute disponibilité du contrôleur est active et qu'elle fonctionne correctement sur votre système de stockage ASA A70 ou ASA A90, puis vérifiez que les adaptateurs du système répertorient tous les chemins d'accès aux disques.
