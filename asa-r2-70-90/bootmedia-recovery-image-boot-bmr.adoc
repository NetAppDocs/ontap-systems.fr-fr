...
summary: 'Si le support de démarrage de votre système ASA A70 ou ASA A90 est corrompu, vous pouvez démarrer l"image de restauration, restaurer la configuration à partir du nœud partenaire et vérifier les variables d"environnement.' 
---
= Restaurez l'image ONTAP - ASA A70 et ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Si le support de démarrage de votre système ASA A70 ou ASA A90 est corrompu, vous pouvez démarrer l'image de restauration et restaurer la configuration à partir du nœud partenaire.
