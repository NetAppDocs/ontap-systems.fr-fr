...
summary: 'Remplacez le contrôleur de votre système ASA A70 ou ASA A90 en cas de panne matérielle ou de mise à niveau. Ce processus implique le retrait du contrôleur défectueux, le déplacement des composants vers le contrôleur de remplacement, l"installation du contrôleur de remplacement et le redémarrage du système.' 
---
= Remplacer le matériel du module de contrôleur - ASA A70 et ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le contrôleur de votre système ASA A70 ou ASA A90 en cas de panne matérielle ou de mise à niveau. Ce processus implique le retrait du contrôleur défectueux, le déplacement des composants vers le contrôleur de remplacement, l'installation du contrôleur de remplacement et le redémarrage du système.
