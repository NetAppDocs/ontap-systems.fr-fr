...
summary: 'Remplacez le châssis de votre système ASA A70 ou ASA A90 en cas de défaillance matérielle. Ce processus implique la mise hors tension du système, le retrait du châssis existant, l"installation du nouveau châssis et la reconfiguration des composants pour garantir le bon fonctionnement du système.' 
---
...
[role="lead"]
Remplacez le châssis de votre système ASA A70 ou ASA A90 en cas de défaillance matérielle. Ce processus implique la mise hors tension du système, le retrait du châssis existant, l'installation du nouveau châssis et la reconfiguration des composants pour garantir le bon fonctionnement du système.
...
.Et la suite ?
Après avoir remplacé le châssis ASA A70 ou ASA A90 défectueux et réinstallé les composants dans celui-ci, vous devez link:chassis-replace-complete-system-restore-rma.html["terminez le remplacement du châssis"].
