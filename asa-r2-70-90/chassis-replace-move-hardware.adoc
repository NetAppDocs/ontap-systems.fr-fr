...
summary: 'Remplacez le châssis de votre système ASA A70 ou ASA A90 en cas de panne matérielle ou de mise à niveau. Ce processus implique la mise hors tension du système, le retrait du châssis existant, l"installation du nouveau châssis et la reconfiguration des composants pour garantir le bon fonctionnement du système.' 
---
...
[role="lead"]
Remplacez le châssis de votre système ASA A70 ou ASA A90 en cas de panne matérielle ou de mise à niveau. Ce processus implique la mise hors tension du système, le retrait du châssis existant, l'installation du nouveau châssis et la reconfiguration des composants pour garantir le bon fonctionnement du système.
