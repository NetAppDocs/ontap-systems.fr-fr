...
summary: Arrêtez le contrôleur de votre système de stockage ASA A70 ou ASA A90 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du contrôleur. 
---
= Arrêter le contrôleur défectueux - ASA A70 et ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez le contrôleur de votre système de stockage ASA A70 ou ASA A90 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du contrôleur.
