...
summary: Arrêtez le contrôleur défectueux de votre système de stockage ASA A70 ou ASA A90 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du support de démarrage. 
---
= Arrêtez le contrôleur pour remplacer le support de démarrage - ASA A70 ou ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez le contrôleur défectueux de votre système de stockage ASA A70 ou ASA A90 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du support de démarrage.
