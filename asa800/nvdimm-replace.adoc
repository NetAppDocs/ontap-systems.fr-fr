...
summary: 'Remplacez la NVDIMM de votre ASA A800 lorsque votre système signale que la durée de vie de la mémoire flash est presque terminée ou que la NVDIMM identifiée n"est généralement pas saine. Si vous ne le faites pas, cela provoquera une panique du système.' 
---
