...
---
= Arrêtez le contrôleur défectueux - ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Éteignez le contrôleur de votre système de stockage ASA A800 pour éviter toute perte de données et garantir la stabilité du système lors du remplacement du contrôleur.
