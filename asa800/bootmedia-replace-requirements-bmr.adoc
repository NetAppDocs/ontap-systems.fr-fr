...
summary: Avant de remplacer le support de démarrage de votre système ASA A800, assurez-vous de respecter les conditions requises pour un remplacement réussi. 
---
= Conditions requises pour la récupération automatique du support de démarrage - ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
