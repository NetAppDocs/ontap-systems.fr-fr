...
summary: Pour rétablir le fonctionnement complet de votre système, vous devez restaurer la configuration de chiffrement du stockage NetApp si nécessaire, installer les licences pour le nouveau contrôleur et renvoyer la pièce défaillante à NetApp. 
---
= Restauration complète du système - ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
