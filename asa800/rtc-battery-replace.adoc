...
summary: 'Remplacez la pile de l"horloge temps réel, communément appelée pile bouton, dans votre système ASA A800 pour garantir que les services et applications nécessitant une synchronisation horaire précise restent opérationnels.' 
---
= Remplacez la batterie de l'horloge temps réel - ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la pile de l'horloge temps réel (RTC), communément appelée pile bouton, de votre système ASA A800 pour garantir le fonctionnement des services et applications nécessitant une synchronisation horaire précise.
