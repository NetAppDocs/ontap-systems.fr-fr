...
sidebar: sidebar 
keywords: ASA A900 
summary: 'Pour remplacer à chaud un module d"alimentation DCPM de contrôleur de désétage, qui contient la batterie NVRAM11, vous devez localiser le module DCPM défectueux, le retirer du châssis et installer le module DCPM de remplacement.' 
---
...
+
image::../media/drw_a900_remove_NV_battery.svg[Retirez la batterie NV]
