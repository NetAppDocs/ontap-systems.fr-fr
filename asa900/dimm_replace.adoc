...
summary: 'Vous devez remplacer une barrette DIMM dans le module contrôleur lorsque votre système enregistre un nombre croissant de codes de correction d"erreurs correctibles ECC. À défaut, le système se bloquera.' 
---
= Remplacez un module DIMM - ASA A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
