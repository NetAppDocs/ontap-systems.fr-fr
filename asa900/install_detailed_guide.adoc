...
Sans objet
 a| 
image:../media/oie_cable_micro_usb.svg["Câble micro USB"]
 a| 
...
Sans objet
 a| 
image:../media/oie_cable_power.svg["largeur=85 px"]
 a| 
...
| Étape | Effectuer des opérations sur chaque contrôleur 
 ...
 a| 
image:../media/oie_legend_icon_1_lg.svg["Icône de légende 1"]
 a| 
...
image:../media/oie_cable_rj45.svg["Câbles RJ-45"]
 ...
 a| 
image:../media/oie_legend_icon_3_o.svg["Icône de légende 3"]
 a| 
...
image:../media/oie_cable100_gbe_qsfp28.svg["Câble de 100 Go"]
 ...
 a| 
image:../media/oie_legend_icon_4_dr.svg["Icône de légende 4"]
 a| 
...
| Étape | Effectuer des opérations sur chaque contrôleur 
 ...
 a| 
image:../media/oie_legend_icon_1_mb.svg["Icône de légende 1"]
 a| 
...
image:../media/oie_cable100_gbe_qsfp28.svg["largeur=50px"]
...
Câble 100 GbE
 ...
 a| 
image:../media/oie_legend_icon_2_lo.svg["Icône de légende 1"]
 a| 
...
Câble 100 GbE
 ...
 a| 
image:../media/oie_legend_icon_2_lo.svg["largeur=30px"]
 a| 
...
LED de l'ID de tiroir
 ...
 a| 
image:../media/legend_icon_04.svg["largeur=20"]
 a| 
...
+
Image : [icône de légende un] drw_a900_POWER-on_IEOPS-941.svg[width=500px]
