...
summary: Tous les autres composants du système doivent fonctionner correctement. Dans le cas contraire, veuillez contacter le support technique. 
---
...
+
image::../media/drw_a900_remove_install_PSU_module.svg[Retirez ou installez un module PSU]
...
+
image::../media/drw_a900_remove_install_fan.svg[Déposer ou installer le ventilateur]
...
+
image::../media/drw_a900_remove_PCM.svg[Retirer le contrôleur]
...
+
image:../media/drw_a900_remove_PCIe_module.svg["Retirez un module PCIe"]
...
+
image::../media/drw_a900_remove_NV_battery.svg[Retirez une batterie NV]
...
image::../media/drw_a900_remove_replace_LED_mod.svg[Retirez ou remplacez un module LED USB]
