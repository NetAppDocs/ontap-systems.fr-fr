...
summary: 'La procédure de démarrage du contrôleur défectueux à partir de l"image de récupération dépend de la configuration du système (MetroCluster à deux nœuds ou non). Le système AFF A300 ne prend en charge que les procédures de récupération manuelles du support de démarrage.' 
---
= Démarrez l'image de restauration - AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La procédure de démarrage du contrôleur défectueux à partir de l'image de récupération dépend de la configuration du système (MetroCluster à deux contrôleurs). Le système AFF A300 ne prend en charge que les procédures de récupération manuelles du support de démarrage. La récupération automatique du support de démarrage n'est pas prise en charge.
