...
[role="lead"]
La procédure de démarrage du contrôleur défaillant à partir de l'image de récupération dépend du fait que le système se trouve dans une configuration MetroCluster à deux contrôleurs.
