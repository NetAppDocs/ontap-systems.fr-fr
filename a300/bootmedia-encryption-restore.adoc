...
summary: Restaurez le chiffrement sur le support de démarrage de remplacement. Suivez les étapes spécifiques aux systèmes disposant du Gestionnaire de clés intégré, du NetApp Storage Encryption ou du NetApp Volume Encryption activés. Le système AFF A300 prend uniquement en charge les procédures de récupération manuelles du support de démarrage. 
---
...
[role="lead"]
Restaurez le chiffrement sur le support de démarrage de remplacement. Le système AFF A300 ne prend en charge que les procédures de récupération manuelles du support de démarrage. La récupération automatique du support de démarrage n'est pas prise en charge.
