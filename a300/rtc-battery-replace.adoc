...
summary: 'Remplacez la pile de l"horloge temps réel de votre module contrôleur AFF A300 pour garantir le bon fonctionnement des services et applications qui dépendent d"une synchronisation horaire précise.' 
---
= Remplacez la pile de l'horloge en temps réel - AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_rxl_rtc_battery.png[Retirez ou remplacez la batterie RTC]
