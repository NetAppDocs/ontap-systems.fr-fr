...
summary: 'Après avoir effectué le remplacement du support de démarrage dans une configuration MetroCluster à deux nœuds, effectuez l"opération de basculement MetroCluster pour ramener la configuration à son état de fonctionnement normal. Le système AFF A300 ne prend en charge que les procédures de récupération manuelle du support de démarrage.' 
---
