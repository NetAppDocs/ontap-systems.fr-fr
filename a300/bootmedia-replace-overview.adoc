...
summary: 'Le support de démarrage stocke un ensemble principal et un ensemble secondaire de fichiers système (image de démarrage) que le système utilise lors de son démarrage. Le système AFF A300 ne prend en charge que les procédures de récupération manuelles du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge. Selon la configuration de votre réseau, vous pouvez effectuer un remplacement non perturbateur ou perturbateur.' 
---
