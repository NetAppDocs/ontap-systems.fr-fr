...
summary: 'Le support de démarrage contient un ensemble principal et un ensemble secondaire de fichiers système que le système utilise lors du démarrage. Le système AFF A300 ne prend en charge que les procédures de récupération manuelle du support de démarrage. La récupération automatique du support de démarrage n"est pas prise en charge. Selon la configuration de votre réseau, vous pouvez effectuer un remplacement non disruptif ou disruptif.' 
---
