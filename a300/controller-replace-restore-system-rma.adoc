...
summary: Pour rétablir le fonctionnement complet de votre système AFF A300, restaurez la configuration de chiffrement du stockage NetApp si nécessaire, installez les licences pour le nouveau contrôleur et renvoyez la pièce défectueuse à NetApp. 
---
= Restauration complète du système - AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
