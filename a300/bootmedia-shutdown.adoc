...
summary: Vous pouvez arrêter ou prendre le contrôle du contrôleur défaillant en utilisant différentes procédures, selon la configuration matérielle du système de stockage. Le système AFF A300 ne prend en charge que les procédures de récupération manuelles du support de démarrage. 
---
...
[role="lead"]
Arrêtez ou prenez le contrôle du contrôleur défaillant en utilisant la procédure appropriée à votre configuration. Le système AFF A300 ne prend en charge que les procédures de récupération manuelles du support de démarrage. La récupération automatique du support de démarrage n'est pas prise en charge.
