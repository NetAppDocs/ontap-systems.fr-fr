...
---
= Démarrer l'image de restauration : AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous devez démarrer l'image ONTAP à partir de la clé USB, restaurer le système de fichiers et vérifier les variables d'environnement. Le système AFF A200 ne prend en charge que les procédures de récupération manuelles du support de démarrage. La récupération automatique du support de démarrage n'est pas prise en charge.
