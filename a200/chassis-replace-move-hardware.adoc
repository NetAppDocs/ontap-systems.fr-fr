...
---
= Déplacement et remplacement du matériel - AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Déplacez le bloc d'alimentation de l'ancien châssis vers le châssis de remplacement.
...
CAUTION: Ne pas exercer de force excessive lors du glissement du bloc d'alimentation dans le système. Vous pouvez endommager le connecteur.
