...
summary: Après avoir allumé votre système de stockage AFF A20, AFF A30 ou AFF A50, vous êtes prêt à détecter votre réseau en cluster et à configurer un cluster ONTAP. 
---
...
[role="lead"]
Après avoir allumé votre système de stockage AFF A20, AFF A30 ou AFF A50, vous êtes prêt à détecter votre réseau en cluster et à configurer un cluster ONTAP.
