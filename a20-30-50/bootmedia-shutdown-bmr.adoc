...
summary: Arrêtez le contrôleur défectueux de votre système de stockage AFF A20, AFF A30 ou AFF A50 pour éviter la perte de données et maintenir la stabilité du système pendant le processus de récupération automatique du support de démarrage. 
---
= Arrêtez le contrôleur pour la récupération automatique du support de démarrage - AFF A20, AFF A30 et AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez le contrôleur défectueux de votre système de stockage AFF A20, AFF A30 ou AFF A50 pour éviter la perte de données et maintenir la stabilité du système pendant le processus de récupération automatique du support de démarrage.
