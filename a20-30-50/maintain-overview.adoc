...
summary: Entretenir le matériel AFF A20, AFF A30 et AFF A50 
---
...
[role="lead"]
Vous devrez peut-être effectuer des procédures de maintenance sur votre matériel. Les procédures spécifiques à l'entretien des composants du système AFF A20, AFF A30 et AFF A50 sont décrites dans cette section.

Les procédures décrites dans cette section supposent que les systèmes de stockage AFF A20, AFF A30 ou AFF A50 ont déjà été déployés en tant que nœuds de stockage dans l'environnement ONTAP.
