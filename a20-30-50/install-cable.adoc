...
+
image:../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg["Schéma de câblage d'un cluster commuté a20 utilisant un module d'E/S 25 GbE"]
...
.AFF A20, AFF A30 ou AFF A50 avec un module d'E/S 10/25 GbE à 4 ports
...
.AFF A20, AFF A30 ou AFF A50 avec un module d'E/S FC 64 Gb/s à 4 ports
