...
[role="lead"]
La récupération manuelle de l'image de démarrage implique l'utilisation d'une clé USB pour réinstaller ONTAP sur le support de démarrage de remplacement du système de stockage AFF A20, AFF A30 ou AFF A50. Vous devez télécharger l'image de récupération ONTAP appropriée depuis le site de support NetApp et la copier sur une clé USB. Cette clé USB préparée est ensuite utilisée pour effectuer la récupération et restaurer le système à son état opérationnel.
