...
summary: 'Pour terminer le remplacement du contrôleur de votre système de stockage AFF A20, AFF A30 ou AFF A50, restaurez la configuration NetApp Storage Encryption et installez les licences requises sur le nouveau contrôleur. Confirmez que les interfaces logiques rapportent à leurs ports d"attache et effectuez une vérification de l"état du cluster. Enregistrez le numéro de série du nouveau contrôleur et retournez la pièce défaillante à NetApp.' 
---
