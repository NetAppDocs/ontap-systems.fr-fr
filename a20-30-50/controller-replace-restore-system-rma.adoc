...
summary: 'Pour restaurer le fonctionnement complet de votre système AFF A20, AFF A30 ou AFF A50, installez les licences requises sur le nouveau contrôleur, vérifiez que les interfaces logiques signalent leurs ports de base et vérifiez l"état du cluster. Enfin, enregistrez le nouveau numéro de série du contrôleur, puis renvoyez la pièce défectueuse à NetApp.' 
---
