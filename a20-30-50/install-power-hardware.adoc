...
** L'ID de tiroir affiché à l'avant du châssis du système ne s'allume pas. L'ID de tiroir interne du système est défini sur 00.


. Fixez les cordons d'alimentation à l'aide du dispositif de fixation de chaque bloc d'alimentation. :a20-30-50!:
