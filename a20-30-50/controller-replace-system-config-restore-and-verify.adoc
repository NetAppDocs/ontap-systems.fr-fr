...
.Et la suite ?
Après avoir restauré et vérifié la configuration système de votre système AFF A20, AFF A30 ou AFF A50, vous devez link:controller-replace-recable-reassign-disks.html["remettez le contrôleur en place"].
