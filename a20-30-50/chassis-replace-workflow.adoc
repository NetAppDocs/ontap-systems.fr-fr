...
summary: Pour commencer à remplacer le châssis de votre système de stockage AFF A20, AFF A30 ou AFF A50, consultez les conditions de remplacement requises, éteignez les contrôleurs, retirez et remplacez le châssis et vérifiez le fonctionnement du système. 
---
...
[role="lead"]
Pour commencer à remplacer le châssis de votre système de stockage AFF A20, AFF A30 ou AFF A50, consultez les conditions de remplacement requises, éteignez les contrôleurs, retirez et remplacez le châssis et vérifiez le fonctionnement du système.
