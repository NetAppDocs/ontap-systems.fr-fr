...
summary: Pour les systèmes de stockage AFF A20, AFF A30 ou AFF A50, vous pouvez effectuer les procédures de maintenance des composants suivants. 
---
= Entretenir le matériel AFF A20, AFF A30 et AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Pour les systèmes de stockage AFF A20, AFF A30 ou AFF A50, vous pouvez effectuer les procédures de maintenance des composants suivants.
