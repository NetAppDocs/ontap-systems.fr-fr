...
summary: 'Vérifier l"état HA du châssis, puis renvoyer la pièce défectueuse à NetApp pour terminer l"étape finale de la procédure de remplacement du châssis AFF A20, AFF A30 et AFF A50.' 
---
