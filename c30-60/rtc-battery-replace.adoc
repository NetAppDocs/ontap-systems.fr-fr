...
summary: 'Remplacez la batterie de l"horloge temps réel (RTC), communément appelée pile bouton, dans votre système de stockage AFF C30 ou AFF C60 pour garantir que les services et applications s"appuyant sur une synchronisation horaire précise restent opérationnels.' 
---
