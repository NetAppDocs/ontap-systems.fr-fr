...
summary: 'Remplacez la pile de l"horloge en temps réel (RTC), communément appelée pile bouton, dans votre système AFF C30 ou AFF C60 pour vous assurer que les services et applications reposant sur une synchronisation précise de l"heure restent opérationnels.' 
---
...
[role="lead"]
Remplacez la pile de l'horloge en temps réel (RTC), communément appelée pile bouton, dans votre système AFF C30 ou AFF C60 pour vous assurer que les services et applications reposant sur une synchronisation précise de l'heure restent opérationnels.
