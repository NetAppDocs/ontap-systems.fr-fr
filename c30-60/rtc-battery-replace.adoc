...
summary: 'Remplacez la pile de l"horloge temps réel, communément appelée pile bouton, de votre système de stockage AFF C30 ou AFF C60 pour garantir le fonctionnement des services et applications nécessitant une synchronisation horaire précise.' 
---
= Remplacez la pile de l'horloge temps réel - AFF C30 et AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez la batterie de l'horloge temps réel (RTC), communément appelée pile bouton, dans votre système de stockage AFF C30 ou AFF C60 pour garantir que les services et applications s'appuyant sur une synchronisation horaire précise restent opérationnels.
