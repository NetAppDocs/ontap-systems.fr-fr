...
summary: Maintenance du matériel AFF C30 et AFF C60 
---
...
[role="lead"]
Vous devrez peut-être effectuer des procédures de maintenance sur votre matériel. Les procédures spécifiques à la maintenance des composants du système AFF C30 et AFF C60 sont décrites dans cette section.
