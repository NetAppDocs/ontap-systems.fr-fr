...
summary: 'Après avoir installé le nouveau périphérique de démarrage sur votre système AFF C30 ou AFF C60, vous pouvez démarrer l"image de récupération à partir d"un lecteur USB et restaurer la configuration à partir du nœud partenaire.' 
---
= Démarrez l'image de récupération - AFF C30 et AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir installé le nouveau périphérique de démarrage sur votre système AFF C30 ou AFF C60, vous pouvez démarrer l'image de récupération à partir d'un lecteur USB et restaurer la configuration à partir du nœud partenaire.
