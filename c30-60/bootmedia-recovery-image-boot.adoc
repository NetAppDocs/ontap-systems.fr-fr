...
summary: 'Après avoir installé le nouveau périphérique de démarrage sur votre système AFF C80, vous pouvez démarrer l"image de récupération à partir d"une clé USB et restaurer la configuration à partir du nœud partenaire.' 
---
...
[role="lead"]
Après avoir installé le nouveau périphérique de démarrage sur votre système AFF C80, vous pouvez démarrer l'image de récupération à partir d'une clé USB et restaurer la configuration à partir du nœud partenaire.
