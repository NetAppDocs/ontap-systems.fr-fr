...
summary: 'Après avoir installé le nouveau périphérique de support de démarrage sur votre système AFF C30 ou AFF C60, vous pouvez démarrer l"image de récupération manuellement à partir d"une clé USB pour restaurer la configuration à partir du nœud partenaire.' 
---
