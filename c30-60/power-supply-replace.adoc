...
summary: 'Remplacez une unité d"alimentation CA ou CC de votre système AFF C30 ou AFF C60 en cas de panne ou de panne, en veillant à ce que votre système continue de recevoir l"alimentation requise pour un fonctionnement stable.' 
---
