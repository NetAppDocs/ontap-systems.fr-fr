...
[role="lead"]
Pour installer et configurer votre système de stockage AFF C30 ou AFF C60, vous devez examiner les exigences et considérations relatives à l'installation, préparer votre site, installer et câbler les composants matériels, mettre le système de stockage sous tension et configurer le cluster ONTAP.
