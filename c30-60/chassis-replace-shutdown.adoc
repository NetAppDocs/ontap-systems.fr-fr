...
summary: Arrêtez les contrôleurs de votre système de stockage AFF C30 ou AFF C60 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du châssis. 
---
...
[role="lead"]
Arrêtez les contrôleurs de votre système de stockage AFF C30 ou AFF C60 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du châssis.
