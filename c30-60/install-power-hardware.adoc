...
summary: Lorsque vous connectez les contrôleurs au réseau et aux tiroirs de votre système de stockage AFF C30 ou AFF C60, vos tiroirs et contrôleurs sont mis sous tension. 
---
