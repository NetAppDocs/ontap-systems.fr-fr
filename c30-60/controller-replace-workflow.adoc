...
[role="lead"]
Procédez comme suit pour remplacer votre contrôleur.
...
[role="quick-margin-para"]
Le remplacement du contrôleur inclut le retrait du contrôleur défectueux, le déplacement des composants FRU vers le contrôleur de remplacement, puis l'installation du contrôleur de remplacement dans le boîtier.
