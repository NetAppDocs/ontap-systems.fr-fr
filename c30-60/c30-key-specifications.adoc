...
summary: Spécifications clés de AFF C30 
---
...
[role="lead"]
Voici quelques spécifications sélectionnées pour le système de stockage AFF C30 dans une seule paire haute disponibilité.  Visitez NetApp Hardware Universe (HWU) pour obtenir les spécifications complètes de ce système de stockage.



== Aperçu des spécifications de AFF C30
...
* Type : NAS ; Paires HA : 4 ; Capacité brute : 8,8 Po / 7,9 PiB ; Mémoire maximale : 512 Go
* Type : SAN ; paires HA : 4 ; capacité brute : 8,8 Po / 7,9 PiB ; mémoire maximale : 512 Go
* Type : Paire HA ; Capacité brute : 2,2 Po / 2,0 PiB ; Mémoire maximale : 128 0000
