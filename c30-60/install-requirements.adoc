...
---
= Exigences et considérations relatives à l'installation - AFF C30 et AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Consultez la configuration requise et les éléments à prendre en compte pour votre système de stockage AFF C30 ou AFF C60.
