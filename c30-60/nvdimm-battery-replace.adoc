...
summary: 'Remplacez la batterie NV de votre système de stockage AFF C30 ou AFF C60 lorsque la batterie commence à perdre sa charge ou tombe en panne, car elle est responsable de la préservation des données critiques du système pendant les pannes de courant.  Le processus de remplacement implique l"arrêt du contrôleur défectueux, le retrait du module de contrôleur, le remplacement de la batterie NV, la réinstallation du module de contrôleur et le renvoi de la pièce défectueuse à NetApp.' 
---
= Remplacez la batterie NV - AFF C30 et AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
