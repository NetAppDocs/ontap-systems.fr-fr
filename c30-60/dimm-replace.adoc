...
summary: 'Remplacez un module DIMM dans le module de contrôleur lorsque votre système enregistre un nombre croissant de codes de correction d"erreurs (ECC) pouvant être corrigés ; le non-respect de cette consigne provoque une panique du système.' 
---
