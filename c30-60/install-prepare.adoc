...
summary: 'Préparez l"installation de votre système de stockage AFF C30 ou AFF C60 en préparant le site, en déballez les boîtes et en comparant le contenu des boîtes au bordereau d"expédition, et en enregistrant le système de stockage pour accéder aux avantages de l"assistance.' 
---
= Préparation de l'installation - AFF C30 et AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Préparez l'installation de votre système de stockage AFF C30 ou AFF C60 en préparant le site, en déballez les boîtes et en comparant le contenu des boîtes au bordereau d'expédition, et en enregistrant le système de stockage pour accéder aux avantages de l'assistance.
...
.Étapes
. Localisez les numéros de série du système (SSN) pour chaque contrôleur en cours d’installation.
+
