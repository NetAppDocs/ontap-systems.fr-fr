...
summary: Après avoir allumé votre système de stockage AFF C30 ou AFF C60, vous êtes prêt à détecter votre réseau en cluster et à configurer un cluster ONTAP. 
---
= Installation et configuration complètes du système de stockage - AFF C30 et AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir allumé votre système de stockage AFF C30 ou AFF C60, vous êtes prêt à détecter votre réseau en cluster et à configurer un cluster ONTAP.
