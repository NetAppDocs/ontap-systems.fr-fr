...
---
= Maintenance du matériel AFF C30 et AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Pour les systèmes de stockage AFF C30 ou AFF C60, vous pouvez effectuer les procédures de maintenance des composants suivants.
