...
summary: 'Renvoyez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système de stockage AFF C30 ou AFF C60 puisse reprendre son fonctionnement normal.  La procédure de restitution varie en fonction du type de cryptage utilisé par votre système : aucun cryptage, cryptage OKM Onboard Key Manager ou cryptage EKM External Key Manager.' 
---
= Remettre le contrôleur - AFF C30 et AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Renvoyez le contrôle des ressources de stockage au contrôleur de remplacement afin que votre système de stockage AFF C30 ou AFF C60 puisse reprendre son fonctionnement normal.  La procédure de restitution varie en fonction du type de cryptage utilisé par votre système : aucun cryptage, cryptage Onboard Key Manager (OKM) ou cryptage External Key Manager (EKM).
