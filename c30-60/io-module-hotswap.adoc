...
summary: 'Vous pouvez remplacer à chaud un module d"E/S Ethernet dans votre système de stockage AFF C30 ou AFF C60 si un module tombe en panne et si votre système de stockage répond à toutes les exigences de version ONTAP.' 
---
= Remplacer à chaud un module d'E/S - AFF C30 et AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer à chaud un module d'E/S Ethernet dans votre système de stockage AFF C30 ou AFF C60 si un module tombe en panne et si votre système de stockage répond à toutes les exigences de version ONTAP.
