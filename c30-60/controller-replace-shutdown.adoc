...
summary: Arrêtez le contrôleur défectueux de votre système de stockage AFF C30 ou AFF C60 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du contrôleur. 
---
= Arrêtez le contrôleur défectueux - AFF C30 et AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrêtez le contrôleur défectueux de votre système de stockage AFF C30 ou AFF C60 pour éviter toute perte de données et assurer la stabilité du système lors du remplacement du contrôleur.
