...
summary: 'Remplacez le châssis de votre système AFF C30 ou AFF C60 en cas de défaillance matérielle. Le processus de remplacement implique le retrait du contrôleur et des blocs d"alimentation, le retrait des lecteurs du châssis défectueux, l"installation du châssis de remplacement et la réinstallation des composants du châssis.' 
---
...
[role="lead"]
Remplacez le châssis de votre système AFF C30 ou AFF C60 en cas de défaillance matérielle. Le processus de remplacement implique le retrait du contrôleur et des unités d'alimentation (PSU), le retrait des lecteurs du châssis défectueux, l'installation du châssis de remplacement et la réinstallation des composants du châssis.
...
.Et la suite ?
Après avoir remplacé le châssis AFF C30 ou AFF C60 défectueux et réinstallé les composants dans celui-ci, vous devez link:chassis-replace-complete-system-restore-rma.html["terminez le remplacement du châssis"].
