...
summary: Vous devez localiser le support de démarrage dans le module de commande, puis suivre les instructions pour le remplacer. 
---
= Remplacez le support de démarrage et préparez-vous à la récupération manuelle du démarrage - AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
