...
summary: Remplacez le contrôleur de votre AFF A400 lorsque cela est nécessaire en cas de défaillance matérielle. Retirez le contrôleur défectueux, transférez ses composants vers le contrôleur de remplacement, installez le nouveau contrôleur et redémarrez-le. 
---
= Remplacer le contrôleur - AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Remplacez le contrôleur de votre AFF A400 lorsque cela est nécessaire en cas de défaillance matérielle. Retirez le contrôleur défectueux, transférez ses composants vers le contrôleur de remplacement, installez le nouveau contrôleur et redémarrez-le.
...
.Et la suite ?
Après avoir remplacé le contrôleur AFF A400 défectueux, vous devez link:controller-replace-system-config-restore-and-verify.html["restaurez la configuration du système"].
