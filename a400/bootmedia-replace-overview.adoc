...
summary: Le support de démarrage stocke un ensemble principal et un ensemble secondaire de fichiers système que le système utilise lors de son démarrage. 
---
= Présentation du remplacement du support de démarrage - AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
