...
image:../media/drw_A400_Replace-PCIe-cards_IEOPS-1008.svg["largeur=500 px"]
...
image::../media/drw_A400_Replace-mezz-card_IEOPS-1006.svg[drw A400 remplacer la carte mezz IOPS 1006]
