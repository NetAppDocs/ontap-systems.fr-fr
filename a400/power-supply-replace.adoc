...
summary: 'Remplacez une alimentation dans votre système AFF A400 en déconnectant l"alimentation cible de la source d"alimentation, en débranchant le câble d"alimentation, en retirant l"ancienne alimentation, en installant l"alimentation de remplacement, puis en la reconnectant à la source d"alimentation.' 
---
= Remplacement à chaud d'une alimentation - AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
