...
summary: 'Remplacez la pile de l"horloge temps réel de votre module contrôleur AFF A400 pour garantir le bon fonctionnement des services et applications qui dépendent d"une synchronisation horaire précise.' 
---
= Remplacez la pile de l'horloge en temps réel - AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/drw_A400_rtc-batt.png[Retirez et remplacez la batterie RTC]
